...
import {
    ...
    BTParameterSpecReferenceTable1520ToJSON,
     BTParameterSpecReferenceText4945FromJSONTyped,
    BTParameterSpecReferenceText4945ToJSON
} from './';
...
export function BTParameterSpecReferenceBlob1367FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTParameterSpecReferenceBlob1367 {
    ...
    if (!ignoreDiscriminator) {
        ...
        if (json['btType'] === 'BTParameterSpecReferenceText-4945') {
            return BTParameterSpecReferenceText4945FromJSONTyped(json, true);
        }
    }
    return {
...
export function BTParameterSpecReferenceBlob1367ToJSON(value?: BTParameterSpecReferenceBlob1367 | null): any {
    ...
    if (value.btType === 'BTParameterSpecReferenceText-4945') {
        return BTParameterSpecReferenceText4945ToJSON(value);
    }
