...
export interface BTMInferenceQueryWithOccurrence1083AllOf {
     ...
     * @memberof BTMInferenceQueryWithOccurrence1083AllOf
     */
    inferenceType?: BTMInferenceQueryWithOccurrence1083AllOfInferenceTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof BTMInferenceQueryWithOccurrence1083AllOf
 ...
 * @export
 */
export const BTMInferenceQueryWithOccurrence1083AllOfInferenceTypeEnum = {
...
export type BTMInferenceQueryWithOccurrence1083AllOfInferenceTypeEnum = typeof BTMInferenceQueryWithOccurrence1083AllOfInferenceTypeEnum[keyof typeof BTMInferenceQueryWithOccurrence1083AllOfInferenceTypeEnum];
...
export function BTMInferenceQueryWithOccurrence1083AllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMInferenceQueryWithOccurrence1083AllOf {
    ...
    return {
        ...
        'inferenceType': !exists(json, 'inferenceType') ? undefined : json['inferenceType'],
