...
export interface BTTreeEdit13 {
     ...
     * @memberof BTTreeEdit13
     */
    editType?: BTTreeEdit13EditTypeEnum;
    /**
     * 
 ...
 * @export
 */
export const BTTreeEdit13EditTypeEnum = {
    Nothing: 'NOTHING',
    NewRoot: 'NEW_ROOT',
    Move: 'MOVE',
    Change: 'CHANGE',
...
export type BTTreeEdit13EditTypeEnum = typeof BTTreeEdit13EditTypeEnum[keyof typeof BTTreeEdit13EditTypeEnum];
...
export function BTTreeEdit13FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTTreeEdit13 {
    ...
    return {
        ...
        'editType': !exists(json, 'editType') ? undefined : json['editType'],
