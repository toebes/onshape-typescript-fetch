...
export interface BTMParameterProgress3232 extends BTMReadOnlyParameter3800 {
     ...
     * @memberof BTMParameterProgress3232
     */
    status?: BTMParameterProgress3232StatusEnum;
    /**
     * 
     * @type {string}
     * @memberof BTMParameterProgress3232
 ...
 * @export
 */
export const BTMParameterProgress3232StatusEnum = {
    Computed: 'COMPUTED',
    Stale: 'STALE',
    Computing: 'COMPUTING',
    Error: 'ERROR',
...
export type BTMParameterProgress3232StatusEnum = typeof BTMParameterProgress3232StatusEnum[keyof typeof BTMParameterProgress3232StatusEnum];
