...
export interface BTRadialDimensionDisplayData348AllOf {
     ...
     * @memberof BTRadialDimensionDisplayData348AllOf
     */
    radiusDisplay?: BTRadialDimensionDisplayData348AllOfRadiusDisplayEnum;
    /**
     * 
     * @type {boolean}
     * @memberof BTRadialDimensionDisplayData348AllOf
 ...
 * @export
 */
export const BTRadialDimensionDisplayData348AllOfRadiusDisplayEnum = {
    None: 'NONE',
    Radial: 'RADIAL',
    Diametral: 'DIAMETRAL',
    Unknown: 'UNKNOWN'
} as const;
export type BTRadialDimensionDisplayData348AllOfRadiusDisplayEnum = typeof BTRadialDimensionDisplayData348AllOfRadiusDisplayEnum[keyof typeof BTRadialDimensionDisplayData348AllOfRadiusDisplayEnum];
...
export function BTRadialDimensionDisplayData348AllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTRadialDimensionDisplayData348AllOf {
    ...
    return {
        ...
        'radiusDisplay': !exists(json, 'radiusDisplay') ? undefined : json['radiusDisplay'],
...
export function BTRadialDimensionDisplayData348AllOfToJSON(value?: BTRadialDimensionDisplayData348AllOf | null): any {
    ...
    return {
        ...
        'radiusDisplay': value.radiusDisplay,
