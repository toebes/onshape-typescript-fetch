...
export interface BTPNode7 {
     ...
     * @memberof BTPNode7
     */
    documentationType?: BTPNode7DocumentationTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof BTPNode7
 ...
 * @export
 */
export const BTPNode7DocumentationTypeEnum = {
    Function: 'FUNCTION',
    Predicate: 'PREDICATE',
    Constant: 'CONSTANT',
    Enum: 'ENUM',
...
export type BTPNode7DocumentationTypeEnum = typeof BTPNode7DocumentationTypeEnum[keyof typeof BTPNode7DocumentationTypeEnum];
