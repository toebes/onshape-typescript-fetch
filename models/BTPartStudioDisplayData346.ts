...
import type { BTBaseEntityAppearanceSettings1391 } from './BTBaseEntityAppearanceSettings1391';
import {
    BTBaseEntityAppearanceSettings1391FromJSON,
    BTBaseEntityAppearanceSettings1391FromJSONTyped,
    BTBaseEntityAppearanceSettings1391ToJSON,
} from './BTBaseEntityAppearanceSettings1391';
...
export interface BTPartStudioDisplayData346 {
    /**
     * 
     * @type {{ [key: string]: { [key: string]: BTInsertableDisplayData2405; }; }}
     * @memberof BTPartStudioDisplayData346
     */
    allInsertableDisplayData?: { [key: string]: { [key: string]: BTInsertableDisplayData2405; }; };
    /**
     * 
     ...
     * @memberof BTPartStudioDisplayData346
     */
    partIdAndTessellationSettingToBuffers?: { [key: string]: { [key: string]: BTInsertableDisplayData2405; }; };
    /**
     * 
     * @type {{ [key: string]: { [key: string]: BTInsertableDisplayData2405; }; }}
     * @memberof BTPartStudioDisplayData346
     */
    sketchFeatureIdAndTessellationSettingToBuffers?: { [key: string]: { [key: string]: BTInsertableDisplayData2405; }; };
    /**
     * 
...
export function BTPartStudioDisplayData346FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTPartStudioDisplayData346 {
    ...
    return {
        ...
        'allInsertableDisplayData': !exists(json, 'allInsertableDisplayData') ? undefined : json['allInsertableDisplayData'],
        ...
        'bodyIdToEntityAppearanceSettings': !exists(json, 'bodyIdToEntityAppearanceSettings') ? undefined : (mapValues(json['bodyIdToEntityAppearanceSettings'], BTBaseEntityAppearanceSettings1391FromJSON)),
        'bodyIdToEntityAppearanceSettingsChanged': !exists(json, 'bodyIdToEntityAppearanceSettingsChanged') ? undefined : json['bodyIdToEntityAppearanceSettingsChanged'],
        ...
        'partIdAndTessellationSettingToBuffers': !exists(json, 'partIdAndTessellationSettingToBuffers') ? undefined : json['partIdAndTessellationSettingToBuffers'],
        'sketchFeatureIdAndTessellationSettingToBuffers': !exists(json, 'sketchFeatureIdAndTessellationSettingToBuffers') ? undefined : json['sketchFeatureIdAndTessellationSettingToBuffers'],
...
export function BTPartStudioDisplayData346ToJSON(value?: BTPartStudioDisplayData346 | null): any {
    ...
    return {
        ...
        'allInsertableDisplayData': value.allInsertableDisplayData,
        ...
        'bodyIdToEntityAppearanceSettings': value.bodyIdToEntityAppearanceSettings === undefined ? undefined : (mapValues(value.bodyIdToEntityAppearanceSettings, BTBaseEntityAppearanceSettings1391ToJSON)),
        'bodyIdToEntityAppearanceSettingsChanged': value.bodyIdToEntityAppearanceSettingsChanged,
        'btType': value.btType,
        ...
        'partIdAndTessellationSettingToBuffers': value.partIdAndTessellationSettingToBuffers,
        'sketchFeatureIdAndTessellationSettingToBuffers': value.sketchFeatureIdAndTessellationSettingToBuffers,
