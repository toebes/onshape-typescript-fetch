...
export interface BTEntityFace31 extends BTTessellatedGeometry2576 {
     ...
     * @memberof BTEntityFace31
     */
    surfaceType?: BTEntityFace31SurfaceTypeEnum;
    /**
     * 
     * @type {BTImmutableFloatArray}
     * @memberof BTEntityFace31
 ...
 * @export
 */
export const BTEntityFace31SurfaceTypeEnum = {
    Plane: 'PLANE',
    Cylinder: 'CYLINDER',
    Cone: 'CONE',
    Sphere: 'SPHERE',
...
export type BTEntityFace31SurfaceTypeEnum = typeof BTEntityFace31SurfaceTypeEnum[keyof typeof BTEntityFace31SurfaceTypeEnum];
...
export function BTEntityFace31FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTEntityFace31 {
    ...
    return {
        ...
        'surfaceType': !exists(json, 'surfaceType') ? undefined : json['surfaceType'],
