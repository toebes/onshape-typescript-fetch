...
export interface BTTranslationRequestInfo {
     ...
     * @memberof BTTranslationRequestInfo
     */
    requestState?: BTTranslationRequestInfoRequestStateEnum;
    /**
     * 
     * @type {string}
     * @memberof BTTranslationRequestInfo
 ...
 * @export
 */
export const BTTranslationRequestInfoRequestStateEnum = {
    Active: 'ACTIVE',
    Done: 'DONE',
    Failed: 'FAILED'
} as const;
export type BTTranslationRequestInfoRequestStateEnum = typeof BTTranslationRequestInfoRequestStateEnum[keyof typeof BTTranslationRequestInfoRequestStateEnum];
...
export function BTTranslationRequestInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTTranslationRequestInfo {
    ...
    return {
        ...
        'requestState': !exists(json, 'requestState') ? undefined : json['requestState'],
