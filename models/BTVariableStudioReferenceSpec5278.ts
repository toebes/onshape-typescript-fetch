 ...
 * 
 * @export
 * @interface BTVariableStudioReferenceSpec5278
 */
export interface BTVariableStudioReferenceSpec5278 extends BTFeatureSpec129 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTVariableStudioReferenceSpec5278
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTVariableStudioReferenceSpec5278 interface.
 */
export function instanceOfBTVariableStudioReferenceSpec5278(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTVariableStudioReferenceSpec5278FromJSON(json: any): BTVariableStudioReferenceSpec5278 {
    return BTVariableStudioReferenceSpec5278FromJSONTyped(json, false);
}

export function BTVariableStudioReferenceSpec5278FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTVariableStudioReferenceSpec5278 {
...
export function BTVariableStudioReferenceSpec5278ToJSON(value?: BTVariableStudioReferenceSpec5278 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
