 ...
 * 
 * @export
 * @interface BTPModuleId235AllOf
 */
export interface BTPModuleId235AllOf {
    /**
     * 
     * @type {string}
     * @memberof BTPModuleId235AllOf
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTPModuleId235AllOf interface.
 */
export function instanceOfBTPModuleId235AllOf(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTPModuleId235AllOfFromJSON(json: any): BTPModuleId235AllOf {
    return BTPModuleId235AllOfFromJSONTyped(json, false);
}

export function BTPModuleId235AllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTPModuleId235AllOf {
...
export function BTPModuleId235AllOfToJSON(value?: BTPModuleId235AllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
