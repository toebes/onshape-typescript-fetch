...
export interface BTComputedAssemblyPropertyConfig {
     ...
     * @memberof BTComputedAssemblyPropertyConfig
     */
    aggregationOperator?: BTComputedAssemblyPropertyConfigAggregationOperatorEnum;
    /**
     * 
     * @type {string}
     * @memberof BTComputedAssemblyPropertyConfig
     */
    errorValuePolicy?: BTComputedAssemblyPropertyConfigErrorValuePolicyEnum;
    /**
     * 
     * @type {string}
     * @memberof BTComputedAssemblyPropertyConfig
     ...
     * @memberof BTComputedAssemblyPropertyConfig
     */
    missingValuePolicy?: BTComputedAssemblyPropertyConfigMissingValuePolicyEnum;
    /**
     * 
     * @type {string}
     * @memberof BTComputedAssemblyPropertyConfig
 ...
 * @export
 */
export const BTComputedAssemblyPropertyConfigAggregationOperatorEnum = {
    Sum: 'SUM',
    Minimum: 'MINIMUM',
    Maximum: 'MAXIMUM',
    Average: 'AVERAGE',
...
export type BTComputedAssemblyPropertyConfigAggregationOperatorEnum = typeof BTComputedAssemblyPropertyConfigAggregationOperatorEnum[keyof typeof BTComputedAssemblyPropertyConfigAggregationOperatorEnum];

/**
 * @export
 */
export const BTComputedAssemblyPropertyConfigErrorValuePolicyEnum = {
...
export type BTComputedAssemblyPropertyConfigErrorValuePolicyEnum = typeof BTComputedAssemblyPropertyConfigErrorValuePolicyEnum[keyof typeof BTComputedAssemblyPropertyConfigErrorValuePolicyEnum];

/**
 * @export
 */
export const BTComputedAssemblyPropertyConfigMissingValuePolicyEnum = {
    ExcludeFromComputation: 'ExcludeFromComputation',
    TreatAsZero: 'TreatAsZero',
    TreatAsTrue: 'TreatAsTrue',
    TreatAsFalse: 'TreatAsFalse',
...
export type BTComputedAssemblyPropertyConfigMissingValuePolicyEnum = typeof BTComputedAssemblyPropertyConfigMissingValuePolicyEnum[keyof typeof BTComputedAssemblyPropertyConfigMissingValuePolicyEnum];
...
export function BTComputedAssemblyPropertyConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTComputedAssemblyPropertyConfig {
    ...
    return {
        ...
        'aggregationOperator': !exists(json, 'aggregationOperator') ? undefined : json['aggregationOperator'],
        'errorValuePolicy': !exists(json, 'errorValuePolicy') ? undefined : json['errorValuePolicy'],
        ...
        'missingValuePolicy': !exists(json, 'missingValuePolicy') ? undefined : json['missingValuePolicy'],
...
export function BTComputedAssemblyPropertyConfigToJSON(value?: BTComputedAssemblyPropertyConfig | null): any {
    ...
    return {
        ...
        'aggregationOperator': value.aggregationOperator,
        'errorValuePolicy': value.errorValuePolicy,
