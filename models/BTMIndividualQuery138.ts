...
export function BTMIndividualQuery138FromJSON(
    json: any
): BTMIndividualQuery138 {
    return BTMIndividualQuery138FromJSONTyped(json, false);
}

export function BTMIndividualQuery138FromJSONTyped(
    json: any,
    ...
    if (!ignoreDiscriminator) {
        ...
        if (json['btType'] === 'BTMIndividualSketchUniqueVerticesQuery-1472') {
            return BTMIndividualSketchUniqueVerticesQuery1472FromJSONTyped(
                json,
                true
            );
        }
    ...
    return {
        ...
        persistentQuery: !exists(json, 'persistentQuery')
            ? undefined
            : BTPStatement269FromJSON(json['persistentQuery']),
        queryStatement: !exists(json, 'queryStatement')
            ? undefined
            : BTPStatement269FromJSON(json['queryStatement']),
        variableName: !exists(json, 'variableName')
            ? undefined
            : BTMIndividualQuery138FromJSON(json['variableName']),
    };
}

export function BTMIndividualQuery138BaseToJSON(
    value?: BTMIndividualQuery138 | null
): any {
    if (value === undefined) {
        return undefined;
    }
...
export function BTMIndividualQuery138ToJSON(
    value?: BTMIndividualQuery138 | null
): any {
    if (value === undefined) {
        return undefined;
    ...
    return BTMIndividualQuery138BaseToJSON(value);
}
