...
import {
    ...
    BTAssemblyReplicate2774ToJSON,
     BTDerivedAssemblyMirror4204FromJSONTyped,
    BTDerivedAssemblyMirror4204ToJSON,
...
export function BTParametricInstance2641FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTParametricInstance2641 {
    ...
    if (!ignoreDiscriminator) {
        ...
        if (json['btType'] === 'BTDerivedAssemblyMirror-4204') {
            return BTDerivedAssemblyMirror4204FromJSONTyped(json, true);
        }
    ...
    return {
        ...
        'seedBasedParametricInstance': !exists(json, 'seedBasedParametricInstance') ? undefined : json['seedBasedParametricInstance'],
    };
}
...
export function BTParametricInstance2641SuperToJSON(value?: BTParametricInstance2641 | null): any {
    ...
    return {
        ...
        'seedBasedParametricInstance': value.seedBasedParametricInstance,
    };
}
...
export function BTParametricInstance2641ToJSON(value?: BTParametricInstance2641 | null): any {
    ...
    if (value.btType === 'BTDerivedAssemblyMirror-4204') {
        return BTDerivedAssemblyMirror4204ToJSON(value);
    }
