...
export const GBTErrorStringEnum = {
    ...
    ParameterExpressionValidationUnitsMismatch3Args: 'PARAMETER_EXPRESSION_VALIDATION_UNITS_MISMATCH_3ARGS',
    ParameterExpressionValidationSyntaxError0Args: 'PARAMETER_EXPRESSION_VALIDATION_SYNTAX_ERROR_0ARGS',
    ParameterExpressionValidationReservedId1Arg: 'PARAMETER_EXPRESSION_VALIDATION_RESERVED_ID_1ARG',
    ParameterExpressionValidationCannotApplyOpTo1Arg: 'PARAMETER_EXPRESSION_VALIDATION_CANNOT_APPLY_OP_TO_1ARG',
    ParameterExpressionValidationCannotApplyOpTo2Args: 'PARAMETER_EXPRESSION_VALIDATION_CANNOT_APPLY_OP_TO_2ARGS',
    ParameterExpressionValidationCannotApplyOpTo3Args: 'PARAMETER_EXPRESSION_VALIDATION_CANNOT_APPLY_OP_TO_3ARGS',
    ParameterExpressionValidationIncorrectType: 'PARAMETER_EXPRESSION_VALIDATION_INCORRECT_TYPE',
    ParameterExpressionUnknownFunction: 'PARAMETER_EXPRESSION_UNKNOWN_FUNCTION',
    ParameterExpressionUnknownVariable: 'PARAMETER_EXPRESSION_UNKNOWN_VARIABLE',
    RevolveNotCoplanarWithAxis: 'REVOLVE_NOT_COPLANAR_WITH_AXIS',
    FrameAngleReferenceInvalidEntity: 'FRAME_ANGLE_REFERENCE_INVALID_ENTITY',
    AmbiguousGeometryForGussetDefinition: 'AMBIGUOUS_GEOMETRY_FOR_GUSSET_DEFINITION',
    HoleStartBoundInvalid: 'HOLE_START_BOUND_INVALID',
    HoleNoStartBound: 'HOLE_NO_START_BOUND',
    BodyDraftFailed: 'BODY_DRAFT_FAILED',
    BodyDraftNoReferences: 'BODY_DRAFT_NO_REFERENCES',
    BodyDraftNoAngles: 'BODY_DRAFT_NO_ANGLES',
    BodyDraftInvalidAboveAngle: 'BODY_DRAFT_INVALID_ABOVE_ANGLE',
    BodyDraftInvalidBelowAngle: 'BODY_DRAFT_INVALID_BELOW_ANGLE',
    BodyDraftInvalidPartingEntity: 'BODY_DRAFT_INVALID_PARTING_ENTITY',
    BodyDraftInvalidPullDirection: 'BODY_DRAFT_INVALID_PULL_DIRECTION',
    BodyDraftMiterNeedBothSides: 'BODY_DRAFT_MITER_NEED_BOTH_SIDES',
    BodyDraftEdgeSeparationFailed: 'BODY_DRAFT_EDGE_SEPARATION_FAILED',
    BodyDraftEdgeSplitFailed: 'BODY_DRAFT_EDGE_SPLIT_FAILED',
    BodyDraftIsoclineSplitFailed: 'BODY_DRAFT_ISOCLINE_SPLIT_FAILED',
    BodyDraftPartingPlaneSheetError: 'BODY_DRAFT_PARTING_PLANE_SHEET_ERROR',
    BodyDraftInvalidReference: 'BODY_DRAFT_INVALID_REFERENCE',
    BodyDraftReferenceLoop: 'BODY_DRAFT_REFERENCE_LOOP',
    BodyDraftTooSteep: 'BODY_DRAFT_TOO_STEEP',
    BodyDraftBadPullDirection: 'BODY_DRAFT_BAD_PULL_DIRECTION',
    BodyDraftMiterFailed: 'BODY_DRAFT_MITER_FAILED',
    DecalHorizontalReferenceInvalidEntity: 'DECAL_HORIZONTAL_REFERENCE_INVALID_ENTITY',
    OffsetWireSheetCreationFailed: 'OFFSET_WIRE_SHEET_CREATION_FAILED',
    ReplaceFaceSheetSmall: 'REPLACE_FACE_SHEET_SMALL',
    ReplaceFacesNotAdjacent: 'REPLACE_FACES_NOT_ADJACENT',
    SheetMetalHoleRebuildFailed: 'SHEET_METAL_HOLE_REBUILD_FAILED',
    CplaneTangentInput: 'CPLANE_TANGENT_INPUT',
    CplaneTangentSelectReference: 'CPLANE_TANGENT_SELECT_REFERENCE',
    CplaneTangentPlaneInvalid: 'CPLANE_TANGENT_PLANE_INVALID',
    CplaneTangentPointInvalid: 'CPLANE_TANGENT_POINT_INVALID',
    ReplaceFacesNotSameBody: 'REPLACE_FACES_NOT_SAME_BODY',
    MustUseDefaultRadiusWithFaceBend: 'MUST_USE_DEFAULT_RADIUS_WITH_FACE_BEND',
    CannotRipAFaceBend: 'CANNOT_RIP_A_FACE_BEND',
    CannotMakeAFaceBendTangent: 'CANNOT_MAKE_A_FACE_BEND_TANGENT',
    SketchHasPatternTooLarge: 'SKETCH_HAS_PATTERN_TOO_LARGE',
    SketchLinearPatternFailed: 'SKETCH_LINEAR_PATTERN_FAILED',
    DecalProjectedOffFace: 'DECAL_PROJECTED_OFF_FACE',
    FitToleranceLimitsNotFound: 'FIT_TOLERANCE_LIMITS_NOT_FOUND',
    FitToleranceSizeTooLargeIso: 'FIT_TOLERANCE_SIZE_TOO_LARGE_ISO',
    FitToleranceSizeTooLargeAnsi: 'FIT_TOLERANCE_SIZE_TOO_LARGE_ANSI',
    DecalNoFaceSelection: 'DECAL_NO_FACE_SELECTION',
    DecalNoImageSelection: 'DECAL_NO_IMAGE_SELECTION',
    DecalImageTooLarge: 'DECAL_IMAGE_TOO_LARGE',
    FgsSimulationAssemblyHasNoInstances: 'FGS_SIMULATION_ASSEMBLY_HAS_NO_INSTANCES',
    FgsSimulationAssemblyHasTooFewInstances: 'FGS_SIMULATION_ASSEMBLY_HAS_TOO_FEW_INSTANCES',
    FgsModalSimulationHasAllFixedParts: 'FGS_MODAL_SIMULATION_HAS_ALL_FIXED_PARTS',
    BodyDraftStrayNonmiterEdges: 'BODY_DRAFT_STRAY_NONMITER_EDGES',
    MassPropertyFacesNotCoplanar: 'MASS_PROPERTY_FACES_NOT_COPLANAR',
    ParameterValueInvalid: 'PARAMETER_VALUE_INVALID',
    SheetMetalChamferNoTangentBased: 'SHEET_METAL_CHAMFER_NO_TANGENT_BASED',
    ChamferDirectionOverrideNoEffect: 'CHAMFER_DIRECTION_OVERRIDE_NO_EFFECT',
    FilletChamferUnsupported: 'FILLET_CHAMFER_UNSUPPORTED',
    LinearPatternSketchReapplyInfo: 'LINEAR_PATTERN_SKETCH_REAPPLY_INFO',
    CircularPatternSketchReapplyInfo: 'CIRCULAR_PATTERN_SKETCH_REAPPLY_INFO',
    CurvePatternSketchReapplyInfo: 'CURVE_PATTERN_SKETCH_REAPPLY_INFO',
    MirrorSketchReapplyInfo: 'MIRROR_SKETCH_REAPPLY_INFO',
    ChamferHeldBack: 'CHAMFER_HELD_BACK',
    SweepBadLockDirection: 'SWEEP_BAD_LOCK_DIRECTION',
    SheetMetalCounterHoleUnsupported: 'SHEET_METAL_COUNTER_HOLE_UNSUPPORTED',
    SpecifiedFeatureDoesNotExist: 'SPECIFIED_FEATURE_DOES_NOT_EXIST',
    SheetMetalBendNoBendLine: 'SHEET_METAL_BEND_NO_BEND_LINE',
    SheetMetalBendBadBendLine: 'SHEET_METAL_BEND_BAD_BEND_LINE',
    SheetMetalBendNoFace: 'SHEET_METAL_BEND_NO_FACE',
    SheetMetalBendNoParallel: 'SHEET_METAL_BEND_NO_PARALLEL',
    SheetMetalBendNoDirection: 'SHEET_METAL_BEND_NO_DIRECTION',
    SheetMetalBendBadFace: 'SHEET_METAL_BEND_BAD_FACE',
    SheetMetalBendImprintFailed: 'SHEET_METAL_BEND_IMPRINT_FAILED',
    SheetMetalBendBadDecomposition: 'SHEET_METAL_BEND_BAD_DECOMPOSITION',
    SheetMetalBendLinePerpendicularToFace: 'SHEET_METAL_BEND_LINE_PERPENDICULAR_TO_FACE',
    SweepSelectDirection: 'SWEEP_SELECT_DIRECTION',
    SheetMetalBendRollFailed: 'SHEET_METAL_BEND_ROLL_FAILED',
    SheetMetalBothSidesConnected: 'SHEET_METAL_BOTH_SIDES_CONNECTED',
    SheetMetalCannotBendButts: 'SHEET_METAL_CANNOT_BEND_BUTTS',
    SheetMetalBendCollision: 'SHEET_METAL_BEND_COLLISION',
    MissingParameterReference: 'MISSING_PARAMETER_REFERENCE',
    MissingImageParameterReference: 'MISSING_IMAGE_PARAMETER_REFERENCE',
    BodyDraftSelectEdges: 'BODY_DRAFT_SELECT_EDGES',
    BodyDraftSelectFaces: 'BODY_DRAFT_SELECT_FACES',
    BodyDraftSelectParts: 'BODY_DRAFT_SELECT_PARTS',
    SplitEdgeInvalidSurface: 'SPLIT_EDGE_INVALID_SURFACE',
    BodyDraftNoEffect: 'BODY_DRAFT_NO_EFFECT',
    OffsetCurveOnFaceSelectEdges: 'OFFSET_CURVE_ON_FACE_SELECT_EDGES',
    OffsetCurveOnFaceWireEdges: 'OFFSET_CURVE_ON_FACE_WIRE_EDGES',
    OffsetCurveOnFaceInvalidTargets: 'OFFSET_CURVE_ON_FACE_INVALID_TARGETS',
    OffsetCurveOnFaceInvalidDistance: 'OFFSET_CURVE_ON_FACE_INVALID_DISTANCE',
    OffsetCurveOnFaceImprintNoExtend: 'OFFSET_CURVE_ON_FACE_IMPRINT_NO_EXTEND',
    OffsetCurveOnFaceFailedToCreateChain: 'OFFSET_CURVE_ON_FACE_FAILED_TO_CREATE_CHAIN',
    OffsetCurveOnFaceBranchingChain: 'OFFSET_CURVE_ON_FACE_BRANCHING_CHAIN',
    OffsetCurveOnFaceFailed: 'OFFSET_CURVE_ON_FACE_FAILED',
    OffsetCurveOnFaceBadDirection: 'OFFSET_CURVE_ON_FACE_BAD_DIRECTION',
    OffsetCurveOnFaceGeodesicOutside: 'OFFSET_CURVE_ON_FACE_GEODESIC_OUTSIDE',
    OffsetCurveOnFaceExtensionFailed: 'OFFSET_CURVE_ON_FACE_EXTENSION_FAILED',
    OffsetCurveOnFaceChainYieldedNoResult: 'OFFSET_CURVE_ON_FACE_CHAIN_YIELDED_NO_RESULT',
    OffsetCurveOnFaceNoResult: 'OFFSET_CURVE_ON_FACE_NO_RESULT',
    OffsetCurveOnFaceInputWithNoTargets: 'OFFSET_CURVE_ON_FACE_INPUT_WITH_NO_TARGETS',
    OffsetCurveOnFaceEuclideanSidePickFail: 'OFFSET_CURVE_ON_FACE_EUCLIDEAN_SIDE_PICK_FAIL',
    OffsetCurveOnFaceScarEdge: 'OFFSET_CURVE_ON_FACE_SCAR_EDGE',
    OffsetCurveOnFaceClosedCurveNoTrim: 'OFFSET_CURVE_ON_FACE_CLOSED_CURVE_NO_TRIM',
    OffsetCurveOnFaceSideDiffFail: 'OFFSET_CURVE_ON_FACE_SIDE_DIFF_FAIL',
    AngleControlParallelToBend: 'ANGLE_CONTROL_PARALLEL_TO_BEND',
    BodyDraftPartingSurfaceSmall: 'BODY_DRAFT_PARTING_SURFACE_SMALL',
    MassPropertyMateConnectorZAxisNotNormal: 'MASS_PROPERTY_MATE_CONNECTOR_Z_AXIS_NOT_NORMAL',
    DerivedMateConnectorIndexOutOfBounds: 'DERIVED_MATE_CONNECTOR_INDEX_OUT_OF_BOUNDS',
    DerivedMateConnectorNoLongerValid: 'DERIVED_MATE_CONNECTOR_NO_LONGER_VALID',
    DerivedMateConnectorReset: 'DERIVED_MATE_CONNECTOR_RESET',
    DerivedNoMateConnectors: 'DERIVED_NO_MATE_CONNECTORS',
    TessellatedLoftError: 'TESSELLATED_LOFT_ERROR',
    BodyDraftInvalidFaceReference: 'BODY_DRAFT_INVALID_FACE_REFERENCE',
    BodyDraftInvalidEdgeReference: 'BODY_DRAFT_INVALID_EDGE_REFERENCE',
    BodyDraftInvalidPartReference: 'BODY_DRAFT_INVALID_PART_REFERENCE',
    HoleCannotDetermineTappedBody: 'HOLE_CANNOT_DETERMINE_TAPPED_BODY',
    HoleParamsOverriddenInfo: 'HOLE_PARAMS_OVERRIDDEN_INFO',
    HoleTapDiaTooLargeOrEqual: 'HOLE_TAP_DIA_TOO_LARGE_OR_EQUAL',
    SplitAsModificationMultipleResults: 'SPLIT_AS_MODIFICATION_MULTIPLE_RESULTS',
    FormedTagFormNoFeaturePattern: 'FORMED_TAG_FORM_NO_FEATURE_PATTERN',
    FormedTagFormSelectDifferentParts: 'FORMED_TAG_FORM_SELECT_DIFFERENT_PARTS',
    FormedTagFormSelectSketch: 'FORMED_TAG_FORM_SELECT_SKETCH',
    FormedTagFormSelectSomething: 'FORMED_TAG_FORM_SELECT_SOMETHING',
    IsoparametricCurveSelectFace: 'ISOPARAMETRIC_CURVE_SELECT_FACE',
    IsoparametricCurveSelectPoint: 'ISOPARAMETRIC_CURVE_SELECT_POINT',
    IsoparametricCurveSelectPosition: 'ISOPARAMETRIC_CURVE_SELECT_POSITION',
    IsoparametricCurvePointNotOnFace: 'ISOPARAMETRIC_CURVE_POINT_NOT_ON_FACE',
    ThinSweep3DProfileTrimWarning: 'THIN_SWEEP_3D_PROFILE_TRIM_WARNING',
    ThinSweepFailedToFindTrimPlanesWarning: 'THIN_SWEEP_FAILED_TO_FIND_TRIM_PLANES_WARNING',
    ThinSweepTrimFailed: 'THIN_SWEEP_TRIM_FAILED',
    IsoparametricCurveSelectSingleFace: 'ISOPARAMETRIC_CURVE_SELECT_SINGLE_FACE',
    HoleFastenerFitIsNotApplicable: 'HOLE_FASTENER_FIT_IS_NOT_APPLICABLE',
    PatternSkippedInstancesSeedIndex: 'PATTERN_SKIPPED_INSTANCES_SEED_INDEX',
    PatternSkippedInstancesOutOfRangeIndex: 'PATTERN_SKIPPED_INSTANCES_OUT_OF_RANGE_INDEX',
    FormedSelectLocation: 'FORMED_SELECT_LOCATION',
    FormedNoPartStudioSelected: 'FORMED_NO_PART_STUDIO_SELECTED',
    FormedSelectLocationOnActiveFace: 'FORMED_SELECT_LOCATION_ON_ACTIVE_FACE',
    FormedLocationOnMultipleFaces: 'FORMED_LOCATION_ON_MULTIPLE_FACES',
    FormedNotOnHoleFormedFace: 'FORMED_NOT_ON_HOLE_FORMED_FACE',
    ThinSweepThickenFailed: 'THIN_SWEEP_THICKEN_FAILED',
    DerivedNoParts: 'DERIVED_NO_PARTS',
    DerivedNoInstancing: 'DERIVED_NO_INSTANCING',
    DerivedNoSameSource: 'DERIVED_NO_SAME_SOURCE',
    DerivedFullFeaturePattern: 'DERIVED_FULL_FEATURE_PATTERN',
    ThinLoft3DProfileTrimWarning: 'THIN_LOFT_3D_PROFILE_TRIM_WARNING',
    ThinLoftFailedToFindTrimPlanesWarning: 'THIN_LOFT_FAILED_TO_FIND_TRIM_PLANES_WARNING',
    ThinLoftThickenFailed: 'THIN_LOFT_THICKEN_FAILED',
    FgsModalSimulationMaximumRigidModesReached: 'FGS_MODAL_SIMULATION_MAXIMUM_RIGID_MODES_REACHED',
    AssemblyMirrorPlaneError: 'ASSEMBLY_MIRROR_PLANE_ERROR',
    PolylineConsecutiveEqualPoints: 'POLYLINE_CONSECUTIVE_EQUAL_POINTS',
    PolylineZeroAngle: 'POLYLINE_ZERO_ANGLE',
    PolylineBendRadiiInvalidSize: 'POLYLINE_BEND_RADII_INVALID_SIZE',
    PolylineInvalidBend: 'POLYLINE_INVALID_BEND',
    SketchMissingLocalReference: 'SKETCH_MISSING_LOCAL_REFERENCE',
    SketchDimensionMissingParameter: 'SKETCH_DIMENSION_MISSING_PARAMETER',
    MateconnectorQuerySecondaryAxisConflict: 'MATECONNECTOR_QUERY_SECONDARY_AXIS_CONFLICT',
    MateconnectorNormalResolutionFailed: 'MATECONNECTOR_NORMAL_RESOLUTION_FAILED',
    LoftPlanarGuideNotFound: 'LOFT_PLANAR_GUIDE_NOT_FOUND',
    PartStudioDoesNotExistInMoment: 'PART_STUDIO_DOES_NOT_EXIST_IN_MOMENT',
    SomeBodiesWereRemovedFromExport: 'SOME_BODIES_WERE_REMOVED_FROM_EXPORT',
    AllBodiesWereRemovedFromExport: 'ALL_BODIES_WERE_REMOVED_FROM_EXPORT',
    ConfigNoParametersFound: 'CONFIG_NO_PARAMETERS_FOUND',
    ConfigIncorrectParameterType: 'CONFIG_INCORRECT_PARAMETER_TYPE',
    ConfigTooManyParameters: 'CONFIG_TOO_MANY_PARAMETERS',
    ReferenceRepairMissingConfiguration: 'REFERENCE_REPAIR_MISSING_CONFIGURATION',
    SketchCannotMake2PointsBezier: 'SKETCH_CANNOT_MAKE_2_POINTS_BEZIER',
    PartInstanceSelectedInMultipleGenerativeDesigns: 'PART_INSTANCE_SELECTED_IN_MULTIPLE_GENERATIVE_DESIGNS',
    CurvePatternLockFacesIntersectionFailed: 'CURVE_PATTERN_LOCK_FACES_INTERSECTION_FAILED',
    SimulationMaterialLacksRequiredPropertyDensity: 'SIMULATION_MATERIAL_LACKS_REQUIRED_PROPERTY_DENSITY',
    SimulationMaterialLacksRequiredPropertyPoissonsRatio: 'SIMULATION_MATERIAL_LACKS_REQUIRED_PROPERTY_POISSONS_RATIO',
    SimulationMaterialLacksRequiredPropertyYoungsModulus: 'SIMULATION_MATERIAL_LACKS_REQUIRED_PROPERTY_YOUNGS_MODULUS',
    SimulationMaterialLacksRequiredPropertyTensileYieldStrength: 'SIMULATION_MATERIAL_LACKS_REQUIRED_PROPERTY_TENSILE_YIELD_STRENGTH',
    SimulationAssemblyHasUnsupportedMates: 'SIMULATION_ASSEMBLY_HAS_UNSUPPORTED_MATES',
    AssemblyNamedPositionsOutsideMateLimit: 'ASSEMBLY_NAMED_POSITIONS_OUTSIDE_MATE_LIMIT',
    AssemblyNamedPositionsSubassemblyOutsideMateLimit: 'ASSEMBLY_NAMED_POSITIONS_SUBASSEMBLY_OUTSIDE_MATE_LIMIT',
    GenerativeRunWasCanceled: 'GENERATIVE_RUN_WAS_CANCELED',
    SketchChamferInvalidPoint: 'SKETCH_CHAMFER_INVALID_POINT',
    SketchChamferParallel: 'SKETCH_CHAMFER_PARALLEL',
    SketchChamferFail: 'SKETCH_CHAMFER_FAIL',
    SketchChamferInvalidInputs: 'SKETCH_CHAMFER_INVALID_INPUTS',
    AssemblyFeatureMissingSelection: 'ASSEMBLY_FEATURE_MISSING_SELECTION',
    AssemblyNamedPositionsLockedSubassemblyFound: 'ASSEMBLY_NAMED_POSITIONS_LOCKED_SUBASSEMBLY_FOUND',
    CurvePatternMissingFaceSelection: 'CURVE_PATTERN_MISSING_FACE_SELECTION',
    TlConnectionOnAllProfiles: 'TL_CONNECTION_ON_ALL_PROFILES',
    TlFailed: 'TL_FAILED',
    TlConnectionsCross: 'TL_CONNECTIONS_CROSS',
    TlSelectProfiles: 'TL_SELECT_PROFILES',
    TlTwoProfiles: 'TL_TWO_PROFILES',
    TlConsecutiveAcorns: 'TL_CONSECUTIVE_ACORNS',
    TlMixedProfiles: 'TL_MIXED_PROFILES',
    TlMixedProfileTopology: 'TL_MIXED_PROFILE_TOPOLOGY',
    TlFailedToCreateProfiles: 'TL_FAILED_TO_CREATE_PROFILES',
    TlConnectionNotOnProfile: 'TL_CONNECTION_NOT_ON_PROFILE',
    SheetMetalFilletNoVariable: 'SHEET_METAL_FILLET_NO_VARIABLE',
    PartiallyInvalidInput: 'PARTIALLY_INVALID_INPUT',
    SketchBezierDegreeDimNotFound: 'SKETCH_BEZIER_DEGREE_DIM_NOT_FOUND',
    InvalidBezierDegree: 'INVALID_BEZIER_DEGREE',
    CannotDeleteBezierDegreeDimension: 'CANNOT_DELETE_BEZIER_DEGREE_DIMENSION',
    DerivedNoInstancingSm: 'DERIVED_NO_INSTANCING_SM',
    DerivedSmAutoInsert: 'DERIVED_SM_AUTO_INSERT',
    AssemblyPatternWrongReferenceWasSelected: 'ASSEMBLY_PATTERN_WRONG_REFERENCE_WAS_SELECTED',
    AssemblyPatternReferenceCouldNotBeFound: 'ASSEMBLY_PATTERN_REFERENCE_COULD_NOT_BE_FOUND',
    DerivedNoActiveSmComposite: 'DERIVED_NO_ACTIVE_SM_COMPOSITE',
    PartialFilletInvalidBoundEntity: 'PARTIAL_FILLET_INVALID_BOUND_ENTITY',
    FgsThicknessUnclosedInput: 'FGS_THICKNESS_UNCLOSED_INPUT',
    FgsThicknessInternalError: 'FGS_THICKNESS_INTERNAL_ERROR',
    SketchSplitNoBezier: 'SKETCH_SPLIT_NO_BEZIER',
    SketchTrimNoBezier: 'SKETCH_TRIM_NO_BEZIER',
    ExportNoParts: 'EXPORT_NO_PARTS',
    SheetMetalFilletOptionsUseCornerBreak: 'SHEET_METAL_FILLET_OPTIONS_USE_CORNER_BREAK',
    SheetMetalChamferOptionsUseCornerBreak: 'SHEET_METAL_CHAMFER_OPTIONS_USE_CORNER_BREAK',
    SheetMetalAttributeCornerBreakUnsupportedSelection: 'SHEET_METAL_ATTRIBUTE_CORNER_BREAK_UNSUPPORTED_SELECTION',
    SheetMetalUseCornerBreakInfo: 'SHEET_METAL_USE_CORNER_BREAK_INFO',
    DrawingViewCorrespondenceFailed: 'DRAWING_VIEW_CORRESPONDENCE_FAILED',
    EditCurveSelectPlane: 'EDIT_CURVE_SELECT_PLANE',
    EditCurveSelectWire: 'EDIT_CURVE_SELECT_WIRE',
    EditCurveMultipleEdges: 'EDIT_CURVE_MULTIPLE_EDGES',
    EditCurveDegreeTooHigh: 'EDIT_CURVE_DEGREE_TOO_HIGH',
    EditCurveIndexTooLarge: 'EDIT_CURVE_INDEX_TOO_LARGE',
    EditCurvePeriodicityChange: 'EDIT_CURVE_PERIODICITY_CHANGE',
    EditCurveFailed: 'EDIT_CURVE_FAILED',
    EditCurveNotWire: 'EDIT_CURVE_NOT_WIRE',
    EditCurveCannotEditSketchWire: 'EDIT_CURVE_CANNOT_EDIT_SKETCH_WIRE',
    EditCurveLockEndsPeriodic: 'EDIT_CURVE_LOCK_ENDS_PERIODIC',
    EditCurveNoBestFit: 'EDIT_CURVE_NO_BEST_FIT',
    PartialFilletOffsetBoundaryTooLarg: 'PARTIAL_FILLET_OFFSET_BOUNDARY_TOO_LARG',
    AssemblyMirrorInvalidSeed: 'ASSEMBLY_MIRROR_INVALID_SEED',
    FlattenCouldNotFlatten: 'FLATTEN_COULD_NOT_FLATTEN',
    FlattenSelectContiguousRegion: 'FLATTEN_SELECT_CONTIGUOUS_REGION',
    RuledSurfaceBadVertex: 'RULED_SURFACE_BAD_VERTEX',
    EditCurveTooManyControlPoints: 'EDIT_CURVE_TOO_MANY_CONTROL_POINTS',
    EditCurveNoEndOverlap: 'EDIT_CURVE_NO_END_OVERLAP',
    EditCurveApproximationDegreeTooSmall: 'EDIT_CURVE_APPROXIMATION_DEGREE_TOO_SMALL',
    EditCurveClosedApproximationNoDerivative: 'EDIT_CURVE_CLOSED_APPROXIMATION_NO_DERIVATIVE',
    ConfigurationParameterHasBadVisibilityCondition: 'CONFIGURATION_PARAMETER_HAS_BAD_VISIBILITY_CONDITION',
    SheetMetalFormedRebuildFailed: 'SHEET_METAL_FORMED_REBUILD_FAILED',
    SketchProfileAnalysisFailed: 'SKETCH_PROFILE_ANALYSIS_FAILED',
    FormedSplitPart: 'FORMED_SPLIT_PART',
    LoftNoDirectionForStart: 'LOFT_NO_DIRECTION_FOR_START',
    LoftNoDirectionForEnd: 'LOFT_NO_DIRECTION_FOR_END',
    TooManySamples: 'TOO_MANY_SAMPLES',
    FormedToolNotNormalToFace: 'FORMED_TOOL_NOT_NORMAL_TO_FACE',
    SheetMetalActiveModelNeeded: 'SHEET_METAL_ACTIVE_MODEL_NEEDED',
    SheetMetalSelectParts: 'SHEET_METAL_SELECT_PARTS',
    SheetMetalInactiveModelSelected: 'SHEET_METAL_INACTIVE_MODEL_SELECTED',
    FormedNotSameLocation: 'FORMED_NOT_SAME_LOCATION',
    SimulationMassOverrideWillBeIgnored: 'SIMULATION_MASS_OVERRIDE_WILL_BE_IGNORED',
    SimulationMassOverrideAreIgnored: 'SIMULATION_MASS_OVERRIDE_ARE_IGNORED',
    FormedTagFormSelectSketchWithWirePoint: 'FORMED_TAG_FORM_SELECT_SKETCH_WITH_WIRE_POINT',
    FormedTagFormBodiesAlreadyTagged: 'FORMED_TAG_FORM_BODIES_ALREADY_TAGGED',
    FormedTagFormPositivePartNotSolid: 'FORMED_TAG_FORM_POSITIVE_PART_NOT_SOLID',
    FormedTagFormNegativePartNotSolid: 'FORMED_TAG_FORM_NEGATIVE_PART_NOT_SOLID',
    FormedTagFormPositivePartConsumed: 'FORMED_TAG_FORM_POSITIVE_PART_CONSUMED',
    FormedTagFormNegativePartConsumed: 'FORMED_TAG_FORM_NEGATIVE_PART_CONSUMED',
    FormedBooleanUnionNoOp: 'FORMED_BOOLEAN_UNION_NO_OP',
    FormedBooleanSubtractNoOp: 'FORMED_BOOLEAN_SUBTRACT_NO_OP',
    FormedFailedToDerive: 'FORMED_FAILED_TO_DERIVE',
    TwoWidthMateconnectorsNeeded: 'TWO_WIDTH_MATECONNECTORS_NEEDED',
    OneTabMateconnectorNeeded: 'ONE_TAB_MATECONNECTOR_NEEDED',
    TwoTabMateconnectorsNeeded: 'TWO_TAB_MATECONNECTORS_NEEDED',
    FormedTagFormOriginOutsideToolsBbox: 'FORMED_TAG_FORM_ORIGIN_OUTSIDE_TOOLS_BBOX',
    FormedToolsIntersectCannotCut: 'FORMED_TOOLS_INTERSECT_CANNOT_CUT',
    RoutingCurveAtLeastTwoDistinctPoints: 'ROUTING_CURVE_AT_LEAST_TWO_DISTINCT_POINTS',
    RoutingCurveOrthoPathAlreadyAxisAligned: 'ROUTING_CURVE_ORTHO_PATH_ALREADY_AXIS_ALIGNED',
    RoutingCurveInvalidPath: 'ROUTING_CURVE_INVALID_PATH',
    RoutingCurveCsvInvalidData: 'ROUTING_CURVE_CSV_INVALID_DATA',
    RoutingCurveCsvNotEnoughColumns: 'ROUTING_CURVE_CSV_NOT_ENOUGH_COLUMNS',
    ExtendToPartFailed: 'EXTEND_TO_PART_FAILED',
    ExtendOffsetFailed: 'EXTEND_OFFSET_FAILED',
    SketchPatternNeedsSeed: 'SKETCH_PATTERN_NEEDS_SEED',
    WrapNeedsDifferentAnchor: 'WRAP_NEEDS_DIFFERENT_ANCHOR',
    CannotResolvePartStudio: 'CANNOT_RESOLVE_PART_STUDIO',
    CannotResolveAssembly: 'CANNOT_RESOLVE_ASSEMBLY',
    NoMeshFound: 'NO_MESH_FOUND',
    ConstrainedSurfaceTooFewPoints: 'CONSTRAINED_SURFACE_TOO_FEW_POINTS',
    ConstrainedSurfaceBadTolerance: 'CONSTRAINED_SURFACE_BAD_TOLERANCE',
    ConstrainedSurfaceBadPosition: 'CONSTRAINED_SURFACE_BAD_POSITION',
    ConstrainedSurfaceFailedTolerance: 'CONSTRAINED_SURFACE_FAILED_TOLERANCE',
    ConstrainedSurfaceFailed: 'CONSTRAINED_SURFACE_FAILED',
    ConstrainedSurfaceSelectMesh: 'CONSTRAINED_SURFACE_SELECT_MESH',
    RoutingCurveSelectCurve: 'ROUTING_CURVE_SELECT_CURVE',
    RoutingCurveAtLeastThreeDistinctPoints: 'ROUTING_CURVE_AT_LEAST_THREE_DISTINCT_POINTS',
    AssemblyMirrorHasReferenceErrors: 'ASSEMBLY_MIRROR_HAS_REFERENCE_ERRORS',
    AssemblyMirrorHasNoReferenceErrors: 'ASSEMBLY_MIRROR_HAS_NO_REFERENCE_ERRORS',
    FeatureNotProvided: 'FEATURE_NOT_PROVIDED',
    TolerantOffsetEndConsumed: 'TOLERANT_OFFSET_END_CONSUMED',
    TolerantOffsetNotToFace: 'TOLERANT_OFFSET_NOT_TO_FACE',
    TolerantDepthNoSecond: 'TOLERANT_DEPTH_NO_SECOND',
    TolerantDepthEndConsumed: 'TOLERANT_DEPTH_END_CONSUMED',
    MixedThicknessTolerance: 'MIXED_THICKNESS_TOLERANCE',
    DoubleThicknessTolerance: 'DOUBLE_THICKNESS_TOLERANCE',
    TolerantAngleNoSecond: 'TOLERANT_ANGLE_NO_SECOND',
    TolerantAngleEndConsumed: 'TOLERANT_ANGLE_END_CONSUMED',
    TolerantThicknessNeedsPlane: 'TOLERANT_THICKNESS_NEEDS_PLANE',
    TolerantSolidOnly: 'TOLERANT_SOLID_ONLY',
    TolerantInvalidOffsetTarget: 'TOLERANT_INVALID_OFFSET_TARGET',
    SheetMetalHemAdjacentCone: 'SHEET_METAL_HEM_ADJACENT_CONE',
    SheetMetalFlangeAdjacentCone: 'SHEET_METAL_FLANGE_ADJACENT_CONE',
    SheetMetalBendReliefCone: 'SHEET_METAL_BEND_RELIEF_CONE',
    SheetMetalActiveModelCannotOffset: 'SHEET_METAL_ACTIVE_MODEL_CANNOT_OFFSET',
    TrimToMultiFailedForUptoBody: 'TRIM_TO_MULTI_FAILED_FOR_UPTO_BODY',
    Unknown: 'UNKNOWN'
} as const;
