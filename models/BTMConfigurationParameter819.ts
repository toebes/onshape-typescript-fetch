...
export interface BTMConfigurationParameter819 {
     ...
     * @memberof BTMConfigurationParameter819
     */
    parameterType?: BTMConfigurationParameter819ParameterTypeEnum;
    /**
     * 
     * @type {boolean}
     * @memberof BTMConfigurationParameter819
 ...
 * @export
 */
export const BTMConfigurationParameter819ParameterTypeEnum = {
    Enum: 'ENUM',
    Boolean: 'BOOLEAN',
    String: 'STRING',
    Quantity: 'QUANTITY'
} as const;
export type BTMConfigurationParameter819ParameterTypeEnum = typeof BTMConfigurationParameter819ParameterTypeEnum[keyof typeof BTMConfigurationParameter819ParameterTypeEnum];
