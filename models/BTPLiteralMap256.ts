...
export interface BTPLiteralMap256 {
     ...
     * @memberof BTPLiteralMap256
     */
    documentationType?: BTPLiteralMap256DocumentationTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof BTPLiteralMap256
 ...
 * @export
 */
export const BTPLiteralMap256DocumentationTypeEnum = {
    Function: 'FUNCTION',
    Predicate: 'PREDICATE',
    Constant: 'CONSTANT',
    Enum: 'ENUM',
...
export type BTPLiteralMap256DocumentationTypeEnum = typeof BTPLiteralMap256DocumentationTypeEnum[keyof typeof BTPLiteralMap256DocumentationTypeEnum];
