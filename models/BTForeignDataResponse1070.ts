...
export interface BTForeignDataResponse1070 {
     ...
     * @memberof BTForeignDataResponse1070
     */
    format?: BTForeignDataResponse1070FormatEnum;
    /**
     * 
     * @type {string}
     * @memberof BTForeignDataResponse1070
 ...
 * @export
 */
export const BTForeignDataResponse1070FormatEnum = {
    XT: 'X_T',
    Xmm: 'XMM',
    Stl: 'STL',
    Onshape: 'ONSHAPE',
...
export type BTForeignDataResponse1070FormatEnum = typeof BTForeignDataResponse1070FormatEnum[keyof typeof BTForeignDataResponse1070FormatEnum];
