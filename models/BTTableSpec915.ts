...
export function BTTableSpec915FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTTableSpec915 {
    ...
    return {
        ...
        'computedPropertyCategoryIds': !exists(json, 'computedPropertyCategoryIds') ? undefined : json['computedPropertyCategoryIds'],
        'defaultPartCategoryId': !exists(json, 'defaultPartCategoryId') ? undefined : json['defaultPartCategoryId'],
...
export function BTTableSpec915ToJSON(value?: BTTableSpec915 | null): any {
    ...
    return {
        ...
        'btType': value.btType,
        'computedPropertyCategoryIds': value.computedPropertyCategoryIds,
        'defaultPartCategoryId': value.defaultPartCategoryId,
