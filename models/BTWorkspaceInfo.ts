...
import type { BTObjectState } from './BTObjectState';
import {
    BTObjectStateFromJSON,
    BTObjectStateFromJSONTyped,
    BTObjectStateToJSON,
} from './BTObjectState';
...
export function BTWorkspaceInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTWorkspaceInfo {
    ...
    return {
        ...
        'state': !exists(json, 'state') ? undefined : BTObjectStateFromJSON(json['state']),
...
export function BTWorkspaceInfoToJSON(value?: BTWorkspaceInfo | null): any {
    ...
    return {
        ...
        'state': BTObjectStateToJSON(value.state),
