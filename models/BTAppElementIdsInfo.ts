...
export interface BTAppElementIdsInfo {
     ...
     * @memberof BTAppElementIdsInfo
     */
    errorValue?: BTAppElementIdsInfoErrorValueEnum;
    /**
     * 
     * @type {Array<string>}
     * @memberof BTAppElementIdsInfo
 ...
 * @export
 */
export const BTAppElementIdsInfoErrorValueEnum = {
    Ok: 'OK',
    TransactionConflict: 'TRANSACTION_CONFLICT',
    NotFound: 'NOT_FOUND',
    InconsistentChanges: 'INCONSISTENT_CHANGES'
} as const;
export type BTAppElementIdsInfoErrorValueEnum = typeof BTAppElementIdsInfoErrorValueEnum[keyof typeof BTAppElementIdsInfoErrorValueEnum];
