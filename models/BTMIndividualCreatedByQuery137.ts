...
export interface BTMIndividualCreatedByQuery137 extends BTMIndividualQuery138 {
     ...
     */
    bodyType?: BTMIndividualCreatedByQuery137BodyTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof BTMIndividualCreatedByQuery137
     ...
     * @memberof BTMIndividualCreatedByQuery137
     */
    entityType?: BTMIndividualCreatedByQuery137EntityTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof BTMIndividualCreatedByQuery137
 ...
 * @export
 */
export const BTMIndividualCreatedByQuery137BodyTypeEnum = {
    Solid: 'SOLID',
    Sheet: 'SHEET',
    Wire: 'WIRE',
    Point: 'POINT',
...
export type BTMIndividualCreatedByQuery137BodyTypeEnum = typeof BTMIndividualCreatedByQuery137BodyTypeEnum[keyof typeof BTMIndividualCreatedByQuery137BodyTypeEnum];

/**
 * @export
 */
export const BTMIndividualCreatedByQuery137EntityTypeEnum = {
    Vertex: 'VERTEX',
    Edge: 'EDGE',
    Face: 'FACE',
    Body: 'BODY',
...
export type BTMIndividualCreatedByQuery137EntityTypeEnum = typeof BTMIndividualCreatedByQuery137EntityTypeEnum[keyof typeof BTMIndividualCreatedByQuery137EntityTypeEnum];
