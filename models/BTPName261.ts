...
export interface BTPName261 {
     ...
     * @memberof BTPName261
     */
    documentationType?: BTPName261DocumentationTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof BTPName261
 ...
 * @export
 */
export const BTPName261DocumentationTypeEnum = {
    Function: 'FUNCTION',
    Predicate: 'PREDICATE',
    Constant: 'CONSTANT',
    Enum: 'ENUM',
...
export type BTPName261DocumentationTypeEnum = typeof BTPName261DocumentationTypeEnum[keyof typeof BTPName261DocumentationTypeEnum];
