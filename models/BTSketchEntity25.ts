...
export interface BTSketchEntity25 extends BTFeatureEntity34 {
     ...
     * @memberof BTSketchEntity25
     */
    sketchCurveType?: BTSketchEntity25SketchCurveTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof BTSketchEntity25
 ...
 * @export
 */
export const BTSketchEntity25SketchCurveTypeEnum = {
    Unset: 'UNSET',
    InterpolatedSpline: 'INTERPOLATED_SPLINE',
    BezierCurve: 'BEZIER_CURVE',
    Unknown: 'UNKNOWN'
} as const;
export type BTSketchEntity25SketchCurveTypeEnum = typeof BTSketchEntity25SketchCurveTypeEnum[keyof typeof BTSketchEntity25SketchCurveTypeEnum];
