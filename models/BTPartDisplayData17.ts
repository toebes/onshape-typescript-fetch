...
export interface BTPartDisplayData17 {
     ...
     * @memberof BTPartDisplayData17
     */
    meshState?: BTPartDisplayData17MeshStateEnum;
    /**
     * 
     * @type {string}
     * @memberof BTPartDisplayData17
     ...
     * @memberof BTPartDisplayData17
     */
    visibility?: BTPartDisplayData17VisibilityEnum;
}
 ...
 * @export
 */
export const BTPartDisplayData17MeshStateEnum = {
    NoMesh: 'NO_MESH',
    Mixed: 'MIXED',
    AllMesh: 'ALL_MESH',
    Unknown: 'UNKNOWN'
} as const;
export type BTPartDisplayData17MeshStateEnum = typeof BTPartDisplayData17MeshStateEnum[keyof typeof BTPartDisplayData17MeshStateEnum];

/**
 * @export
 */
export const BTPartDisplayData17VisibilityEnum = {
    Hidden: 'HIDDEN',
    Visible: 'VISIBLE',
    Unspecified: 'UNSPECIFIED',
    Unknown: 'UNKNOWN'
} as const;
export type BTPartDisplayData17VisibilityEnum = typeof BTPartDisplayData17VisibilityEnum[keyof typeof BTPartDisplayData17VisibilityEnum];
