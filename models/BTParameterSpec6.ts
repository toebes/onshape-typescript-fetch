 ...
 * @export
 */
export const BTParameterSpec6UiHintsEnum = {
...
export type BTParameterSpec6UiHintsEnum = typeof BTParameterSpec6UiHintsEnum[keyof typeof BTParameterSpec6UiHintsEnum];
