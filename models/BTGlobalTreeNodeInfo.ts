...
import {
    ...
    BTDocumentSummaryInfoToJSON,
     BTExternalConnectionInfoFromJSONTyped,
    BTExternalConnectionInfoToJSON,
...
export function BTGlobalTreeNodeInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTGlobalTreeNodeInfo {
    ...
    if (!ignoreDiscriminator) {
        ...
        if (json['jsonType'] === 'external-connection') {
            return BTExternalConnectionInfoFromJSONTyped(json, true);
        }
...
export function BTGlobalTreeNodeInfoToJSON(value?: BTGlobalTreeNodeInfo | null): any {
    ...
    if (value.jsonType === 'external-connection') {
        return BTExternalConnectionInfoToJSON(value);
    }
