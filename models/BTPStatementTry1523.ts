...
export interface BTPStatementTry1523 extends BTPStatement269 {
     ...
     * @memberof BTPStatementTry1523
     */
    standardType?: BTPStatementTry1523StandardTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof BTPStatementTry1523
 ...
 * @export
 */
export const BTPStatementTry1523StandardTypeEnum = {
    Undefined: 'UNDEFINED',
    Boolean: 'BOOLEAN',
    Number: 'NUMBER',
    String: 'STRING',
...
export type BTPStatementTry1523StandardTypeEnum = typeof BTPStatementTry1523StandardTypeEnum[keyof typeof BTPStatementTry1523StandardTypeEnum];
