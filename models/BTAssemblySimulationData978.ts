...
export interface BTAssemblySimulationData978 extends BTMNode19 {
     ...
     * @memberof BTAssemblySimulationData978
     */
    contactBehavior?: BTAssemblySimulationData978ContactBehaviorEnum;
    /**
     * 
 ...
 * @export
 */
export const BTAssemblySimulationData978ContactBehaviorEnum = {
    MatesOnly: 'MATES_ONLY',
    FuseInContact: 'FUSE_IN_CONTACT',
    FuseInContactAndUseMates: 'FUSE_IN_CONTACT_AND_USE_MATES',
    Unknown: 'UNKNOWN'
} as const;
export type BTAssemblySimulationData978ContactBehaviorEnum = typeof BTAssemblySimulationData978ContactBehaviorEnum[keyof typeof BTAssemblySimulationData978ContactBehaviorEnum];
