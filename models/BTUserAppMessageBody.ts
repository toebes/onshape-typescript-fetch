...
export interface BTUserAppMessageBody {
     ...
     * @memberof BTUserAppMessageBody
     */
    settingType?: BTUserAppMessageBodySettingTypeEnum;
    /**
     * 
     * @type {Date}
     * @memberof BTUserAppMessageBody
 ...
 * @export
 */
export const BTUserAppMessageBodySettingTypeEnum = {
    User: 'USER',
    Company: 'COMPANY',
    Team: 'TEAM'
} as const;
export type BTUserAppMessageBodySettingTypeEnum = typeof BTUserAppMessageBodySettingTypeEnum[keyof typeof BTUserAppMessageBodySettingTypeEnum];
...
export function BTUserAppMessageBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTUserAppMessageBody {
    ...
    return {
        ...
        'settingType': !exists(json, 'settingType') ? undefined : json['settingType'],
