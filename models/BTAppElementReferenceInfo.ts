...
export interface BTAppElementReferenceInfo {
     ...
     * @memberof BTAppElementReferenceInfo
     */
    errorValue?: BTAppElementReferenceInfoErrorValueEnum;
    /**
 ...
 * @export
 */
export const BTAppElementReferenceInfoErrorValueEnum = {
    Ok: 'OK',
    TransactionConflict: 'TRANSACTION_CONFLICT',
    NotFound: 'NOT_FOUND',
    InconsistentChanges: 'INCONSISTENT_CHANGES'
} as const;
export type BTAppElementReferenceInfoErrorValueEnum = typeof BTAppElementReferenceInfoErrorValueEnum[keyof typeof BTAppElementReferenceInfoErrorValueEnum];
