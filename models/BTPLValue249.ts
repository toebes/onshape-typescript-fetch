...
export interface BTPLValue249 {
     ...
     * @memberof BTPLValue249
     */
    documentationType?: BTPLValue249DocumentationTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof BTPLValue249
 ...
 * @export
 */
export const BTPLValue249DocumentationTypeEnum = {
    Function: 'FUNCTION',
    Predicate: 'PREDICATE',
    Constant: 'CONSTANT',
    Enum: 'ENUM',
...
export type BTPLValue249DocumentationTypeEnum = typeof BTPLValue249DocumentationTypeEnum[keyof typeof BTPLValue249DocumentationTypeEnum];
