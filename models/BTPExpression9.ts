...
export interface BTPExpression9 {
     ...
     * @memberof BTPExpression9
     */
    documentationType?: BTPExpression9DocumentationTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof BTPExpression9
 ...
 * @export
 */
export const BTPExpression9DocumentationTypeEnum = {
    Function: 'FUNCTION',
    Predicate: 'PREDICATE',
    Constant: 'CONSTANT',
    Enum: 'ENUM',
...
export type BTPExpression9DocumentationTypeEnum = typeof BTPExpression9DocumentationTypeEnum[keyof typeof BTPExpression9DocumentationTypeEnum];
