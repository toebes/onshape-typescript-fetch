 ...
 * 
 * @export
 * @interface BTMParameterQueryWithOccurrenceList67AllOf
 */
export interface BTMParameterQueryWithOccurrenceList67AllOf {
    /**
     * 
     * @type {string}
     * @memberof BTMParameterQueryWithOccurrenceList67AllOf
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTMParameterQueryWithOccurrenceList67AllOf interface.
 */
export function instanceOfBTMParameterQueryWithOccurrenceList67AllOf(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTMParameterQueryWithOccurrenceList67AllOfFromJSON(json: any): BTMParameterQueryWithOccurrenceList67AllOf {
    return BTMParameterQueryWithOccurrenceList67AllOfFromJSONTyped(json, false);
}

export function BTMParameterQueryWithOccurrenceList67AllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMParameterQueryWithOccurrenceList67AllOf {
...
export function BTMParameterQueryWithOccurrenceList67AllOfToJSON(value?: BTMParameterQueryWithOccurrenceList67AllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
