...
export interface BTSketchObjectFilter184 extends BTQueryFilter183 {
     ...
     * @memberof BTSketchObjectFilter184
     */
    objectType?: BTSketchObjectFilter184ObjectTypeEnum;
}
 ...
 * @export
 */
export const BTSketchObjectFilter184ObjectTypeEnum = {
    NotSketchObject: 'NOT_SKETCH_OBJECT',
    AnySketchObject: 'ANY_SKETCH_OBJECT',
    UserEntity: 'USER_ENTITY',
    Unknown: 'UNKNOWN'
} as const;
export type BTSketchObjectFilter184ObjectTypeEnum = typeof BTSketchObjectFilter184ObjectTypeEnum[keyof typeof BTSketchObjectFilter184ObjectTypeEnum];
