...
export interface BTAppElementReferenceResolveInfo {
     ...
     * @memberof BTAppElementReferenceResolveInfo
     */
    errorValue?: BTAppElementReferenceResolveInfoErrorValueEnum;
    /**
     * 
     * @type {string}
     * @memberof BTAppElementReferenceResolveInfo
 ...
 * @export
 */
export const BTAppElementReferenceResolveInfoErrorValueEnum = {
    Ok: 'OK',
    TransactionConflict: 'TRANSACTION_CONFLICT',
    NotFound: 'NOT_FOUND',
    InconsistentChanges: 'INCONSISTENT_CHANGES'
} as const;
export type BTAppElementReferenceResolveInfoErrorValueEnum = typeof BTAppElementReferenceResolveInfoErrorValueEnum[keyof typeof BTAppElementReferenceResolveInfoErrorValueEnum];
