...
export function BTBExportModelParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTBExportModelParams {
    ...
    return {
        ...
        'deepSearchForForeignData': !exists(json, 'deepSearchForForeignData') ? undefined : json['deepSearchForForeignData'],
        ...
        'extractToS3': !exists(json, 'extractToS3') ? undefined : json['extractToS3'],
        ...
        'includeContentCaptures': !exists(json, 'includeContentCaptures') ? undefined : json['includeContentCaptures'],
        'includeCustomPropertiesData': !exists(json, 'includeCustomPropertiesData') ? undefined : json['includeCustomPropertiesData'],
        'includeExportIds': !exists(json, 'includeExportIds') ? undefined : json['includeExportIds'],
        'includeForeignData': !exists(json, 'includeForeignData') ? undefined : json['includeForeignData'],
        'includeItemsData': !exists(json, 'includeItemsData') ? undefined : json['includeItemsData'],
        'includeLinkedDocuments': !exists(json, 'includeLinkedDocuments') ? undefined : json['includeLinkedDocuments'],
        'includeReleaseManagementData': !exists(json, 'includeReleaseManagementData') ? undefined : json['includeReleaseManagementData'],
        'includeSketches': !exists(json, 'includeSketches') ? undefined : json['includeSketches'],
        'includeStd': !exists(json, 'includeStd') ? undefined : json['includeStd'],
        'includeThumbnails': !exists(json, 'includeThumbnails') ? undefined : json['includeThumbnails'],
        ...
        'linkedDocumentSubSetId': !exists(json, 'linkedDocumentSubSetId') ? undefined : json['linkedDocumentSubSetId'],
...
export function BTBExportModelParamsToJSON(value?: BTBExportModelParams | null): any {
    ...
    return {
        ...
        'deepSearchForForeignData': value.deepSearchForForeignData,
        ...
        'includeContentCaptures': value.includeContentCaptures,
        'includeCustomPropertiesData': value.includeCustomPropertiesData,
        'includeExportIds': value.includeExportIds,
        'includeForeignData': value.includeForeignData,
        'includeItemsData': value.includeItemsData,
        'includeLinkedDocuments': value.includeLinkedDocuments,
        'includeReleaseManagementData': value.includeReleaseManagementData,
        'includeSketches': value.includeSketches,
        'includeStd': value.includeStd,
        ...
        'linkedDocumentSubSetId': value.linkedDocumentSubSetId,
