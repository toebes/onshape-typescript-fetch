...
export interface BTTableColumnSpec1967 {
     ...
     * @memberof BTTableColumnSpec1967
     */
    defaultColumnWidthUnits?: BTTableColumnSpec1967DefaultColumnWidthUnitsEnum;
    /**
     * 
     * @type {number}
     * @memberof BTTableColumnSpec1967
     ...
     * @memberof BTTableColumnSpec1967
     */
    defaultTextAlignment?: BTTableColumnSpec1967DefaultTextAlignmentEnum;
    /**
     * 
     * @type {boolean}
     * @memberof BTTableColumnSpec1967
 ...
 * @export
 */
export const BTTableColumnSpec1967DefaultColumnWidthUnitsEnum = {
    Percent: 'PERCENT',
    Chars: 'CHARS',
    Pixels: 'PIXELS',
    Unknown: 'UNKNOWN'
} as const;
export type BTTableColumnSpec1967DefaultColumnWidthUnitsEnum = typeof BTTableColumnSpec1967DefaultColumnWidthUnitsEnum[keyof typeof BTTableColumnSpec1967DefaultColumnWidthUnitsEnum];

/**
 * @export
 */
export const BTTableColumnSpec1967DefaultTextAlignmentEnum = {
    Left: 'LEFT',
    Center: 'CENTER',
    Right: 'RIGHT',
    Unknown: 'UNKNOWN'
} as const;
export type BTTableColumnSpec1967DefaultTextAlignmentEnum = typeof BTTableColumnSpec1967DefaultTextAlignmentEnum[keyof typeof BTTableColumnSpec1967DefaultTextAlignmentEnum];
...
export function BTTableColumnSpec1967FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTTableColumnSpec1967 {
    ...
    return {
        ...
        'defaultColumnWidthUnits': !exists(json, 'defaultColumnWidthUnits') ? undefined : json['defaultColumnWidthUnits'],
        ...
        'defaultTextAlignment': !exists(json, 'defaultTextAlignment') ? undefined : json['defaultTextAlignment'],
...
export function BTTableColumnSpec1967ToJSON(value?: BTTableColumnSpec1967 | null): any {
    ...
    return {
        ...
        'defaultColumnWidthUnits': value.defaultColumnWidthUnits,
        'defaultColumnWidthValue': value.defaultColumnWidthValue,
        'defaultHeaderName': value.defaultHeaderName,
        'defaultTextAlignment': value.defaultTextAlignment,
