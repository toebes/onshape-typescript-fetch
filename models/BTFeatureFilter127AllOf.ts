...
export interface BTFeatureFilter127AllOf {
     ...
     * @memberof BTFeatureFilter127AllOf
     */
    exclusion?: BTFeatureFilter127AllOfExclusionEnum;
    /**
     * 
     * @type {string}
     * @memberof BTFeatureFilter127AllOf
 ...
 * @export
 */
export const BTFeatureFilter127AllOfExclusionEnum = {
    ExcludeEverythingElse: 'EXCLUDE_EVERYTHING_ELSE',
    ExcludeThis: 'EXCLUDE_THIS',
    Unknown: 'UNKNOWN'
} as const;
export type BTFeatureFilter127AllOfExclusionEnum = typeof BTFeatureFilter127AllOfExclusionEnum[keyof typeof BTFeatureFilter127AllOfExclusionEnum];
