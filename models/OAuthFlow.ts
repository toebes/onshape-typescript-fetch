...
import type { OAuthFlowScopes } from './OAuthFlowScopes';
import {
    OAuthFlowScopesFromJSON,
    OAuthFlowScopesFromJSONTyped,
    OAuthFlowScopesToJSON,
} from './OAuthFlowScopes';
...
/**
 * Check if a given object implements the OAuthFlow interface.
 */
export function instanceOfOAuthFlow(value: object): boolean {
    let isInstance = true;
...
export function OAuthFlowFromJSONTyped(json: any, ignoreDiscriminator: boolean): OAuthFlow {
    ...
    return {
        ...
        'refreshUrl': !exists(json, 'refreshUrl') ? undefined : json['refreshUrl'],
        'scopes': !exists(json, 'scopes') ? undefined : OAuthFlowScopesFromJSON(json['scopes']),
...
export function OAuthFlowToJSON(value?: OAuthFlow | null): any {
    ...
    return {
        ...
        'scopes': OAuthFlowScopesToJSON(value.scopes),
