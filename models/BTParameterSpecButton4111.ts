 ...
 * 
 * @export
 * @interface BTParameterSpecButton4111
 */
export interface BTParameterSpecButton4111 extends BTParameterSpec6 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTParameterSpecButton4111
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTParameterSpecButton4111 interface.
 */
export function instanceOfBTParameterSpecButton4111(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTParameterSpecButton4111FromJSON(json: any): BTParameterSpecButton4111 {
    return BTParameterSpecButton4111FromJSONTyped(json, false);
}

export function BTParameterSpecButton4111FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTParameterSpecButton4111 {
...
export function BTParameterSpecButton4111ToJSON(value?: BTParameterSpecButton4111 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
