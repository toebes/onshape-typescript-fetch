 ...
 * 
 * @export
 * @interface BTMWidthMate1011
 */
export interface BTMWidthMate1011 extends BTMAssemblyFeature887 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTMWidthMate1011
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTMWidthMate1011 interface.
 */
export function instanceOfBTMWidthMate1011(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTMWidthMate1011FromJSON(json: any): BTMWidthMate1011 {
    return BTMWidthMate1011FromJSONTyped(json, false);
}

export function BTMWidthMate1011FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMWidthMate1011 {
...
export function BTMWidthMate1011ToJSON(value?: BTMWidthMate1011 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
