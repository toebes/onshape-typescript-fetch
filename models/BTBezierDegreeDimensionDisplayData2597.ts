 ...
 * 
 * @export
 * @interface BTBezierDegreeDimensionDisplayData2597
 */
export interface BTBezierDegreeDimensionDisplayData2597 extends BTDimensionDisplayData323 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTBezierDegreeDimensionDisplayData2597
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTBezierDegreeDimensionDisplayData2597 interface.
 */
export function instanceOfBTBezierDegreeDimensionDisplayData2597(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTBezierDegreeDimensionDisplayData2597FromJSON(json: any): BTBezierDegreeDimensionDisplayData2597 {
    return BTBezierDegreeDimensionDisplayData2597FromJSONTyped(json, false);
}

export function BTBezierDegreeDimensionDisplayData2597FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTBezierDegreeDimensionDisplayData2597 {
...
export function BTBezierDegreeDimensionDisplayData2597ToJSON(value?: BTBezierDegreeDimensionDisplayData2597 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
