...
export interface BTAppElementModifyInfo {
     ...
     * @memberof BTAppElementModifyInfo
     */
    errorValue?: BTAppElementModifyInfoErrorValueEnum;
    /**
     * 
 ...
 * @export
 */
export const BTAppElementModifyInfoErrorValueEnum = {
    Ok: 'OK',
    TransactionConflict: 'TRANSACTION_CONFLICT',
    NotFound: 'NOT_FOUND',
    InconsistentChanges: 'INCONSISTENT_CHANGES'
} as const;
export type BTAppElementModifyInfoErrorValueEnum = typeof BTAppElementModifyInfoErrorValueEnum[keyof typeof BTAppElementModifyInfoErrorValueEnum];
