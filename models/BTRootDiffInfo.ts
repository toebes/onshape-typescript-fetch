...
export interface BTRootDiffInfo {
     ...
     * @memberof BTRootDiffInfo
     */
    entityType?: BTRootDiffInfoEntityTypeEnum;
    /**
     * 
     * @type {Array<string>}
     * @memberof BTRootDiffInfo
 ...
 * @export
 */
export const BTRootDiffInfoEntityTypeEnum = {
    Parts: 'parts',
    Sketches: 'sketches',
    Points: 'points',
...
export type BTRootDiffInfoEntityTypeEnum = typeof BTRootDiffInfoEntityTypeEnum[keyof typeof BTRootDiffInfoEntityTypeEnum];

/**
 * @export
 */
export const BTRootDiffInfoTypeEnum = {
    None: 'NONE',
    Moved: 'MOVED',
    Modified: 'MODIFIED',
...
export type BTRootDiffInfoTypeEnum = typeof BTRootDiffInfoTypeEnum[keyof typeof BTRootDiffInfoTypeEnum];
