...
export interface BTDocumentInfo {
     ...
     * @memberof BTDocumentInfo
     */
    permission?: BTDocumentInfoPermissionEnum;
    /**
     * 
     * @type {Array<string>}
     * @memberof BTDocumentInfo
 ...
 * @export
 */
export const BTDocumentInfoPermissionEnum = {
    Noaccess: 'NOACCESS',
...
export type BTDocumentInfoPermissionEnum = typeof BTDocumentInfoPermissionEnum[keyof typeof BTDocumentInfoPermissionEnum];
