 ...
 * 
 * @export
 * @interface BTDatumTableRowMetadata3060
 */
export interface BTDatumTableRowMetadata3060 extends BTTableBaseRowMetadata3181 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTDatumTableRowMetadata3060
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTDatumTableRowMetadata3060 interface.
 */
export function instanceOfBTDatumTableRowMetadata3060(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTDatumTableRowMetadata3060FromJSON(json: any): BTDatumTableRowMetadata3060 {
    return BTDatumTableRowMetadata3060FromJSONTyped(json, false);
}

export function BTDatumTableRowMetadata3060FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTDatumTableRowMetadata3060 {
...
export function BTDatumTableRowMetadata3060ToJSON(value?: BTDatumTableRowMetadata3060 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
