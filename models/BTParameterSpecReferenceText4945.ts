 ...
 * 
 * @export
 * @interface BTParameterSpecReferenceText4945
 */
export interface BTParameterSpecReferenceText4945 extends BTParameterSpecReferenceBlob1367 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTParameterSpecReferenceText4945
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTParameterSpecReferenceText4945 interface.
 */
export function instanceOfBTParameterSpecReferenceText4945(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTParameterSpecReferenceText4945FromJSON(json: any): BTParameterSpecReferenceText4945 {
    return BTParameterSpecReferenceText4945FromJSONTyped(json, false);
}

export function BTParameterSpecReferenceText4945FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTParameterSpecReferenceText4945 {
...
export function BTParameterSpecReferenceText4945ToJSON(value?: BTParameterSpecReferenceText4945 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
