...
export interface BTPAnnotation231 {
     ...
     * @memberof BTPAnnotation231
     */
    documentationType?: BTPAnnotation231DocumentationTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof BTPAnnotation231
 ...
 * @export
 */
export const BTPAnnotation231DocumentationTypeEnum = {
    Function: 'FUNCTION',
    Predicate: 'PREDICATE',
    Constant: 'CONSTANT',
    Enum: 'ENUM',
...
export type BTPAnnotation231DocumentationTypeEnum = typeof BTPAnnotation231DocumentationTypeEnum[keyof typeof BTPAnnotation231DocumentationTypeEnum];
