...
export interface BTRadialDimensionDisplayData348 extends BTDimensionDisplayData323 {
     ...
     * @memberof BTRadialDimensionDisplayData348
     */
    radiusDisplay?: BTRadialDimensionDisplayData348RadiusDisplayEnum;
    /**
     * 
     * @type {boolean}
     * @memberof BTRadialDimensionDisplayData348
 ...
 * @export
 */
export const BTRadialDimensionDisplayData348RadiusDisplayEnum = {
    None: 'NONE',
    Radial: 'RADIAL',
    Diametral: 'DIAMETRAL',
    Unknown: 'UNKNOWN'
} as const;
export type BTRadialDimensionDisplayData348RadiusDisplayEnum = typeof BTRadialDimensionDisplayData348RadiusDisplayEnum[keyof typeof BTRadialDimensionDisplayData348RadiusDisplayEnum];
