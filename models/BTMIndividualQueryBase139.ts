...
export function BTMIndividualQueryBase139FromJSON(
    json: any
): BTMIndividualQueryBase139 {
    return BTMIndividualQueryBase139FromJSONTyped(json, false);
}

export function BTMIndividualQueryBase139FromJSONTyped(
    json: any,
    ...
    if (!ignoreDiscriminator) {
        ...
        if (json['btType'] === 'BTMIndividualQueryWithOccurrenceBase-904') {
            return BTMIndividualQueryWithOccurrenceBase904FromJSONTyped(
                json,
                true
            );
        }
    ...
    return {
        ...
        deterministicIdList: !exists(json, 'deterministicIdList')
            ? undefined
            : BTMIndividualQueryBase139FromJSON(json['deterministicIdList']),
        deterministicIds: !exists(json, 'deterministicIds')
            ? undefined
            : json['deterministicIds'],
        ...
        query: !exists(json, 'query')
            ? undefined
            : BTMIndividualQueryBase139FromJSON(json['query']),
        queryString: !exists(json, 'queryString')
            ? undefined
            : json['queryString'],
    };
}
...
export function BTMIndividualQueryBase139BaseToJSON(
    ...
    return {
        btType: value.btType,
        deterministicIdList: BTMIndividualQueryBase139ToJSON(
            value.deterministicIdList
        ),
...
export function BTMIndividualQueryBase139ToJSON(
    value?: BTMIndividualQueryBase139 | null
): any {
    if (value === undefined) {
        return undefined;
