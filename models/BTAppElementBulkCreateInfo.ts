...
export interface BTAppElementBulkCreateInfo {
     ...
     * @memberof BTAppElementBulkCreateInfo
     */
    errorValue?: BTAppElementBulkCreateInfoErrorValueEnum;
}
 ...
 * @export
 */
export const BTAppElementBulkCreateInfoErrorValueEnum = {
    Ok: 'OK',
    TransactionConflict: 'TRANSACTION_CONFLICT',
    NotFound: 'NOT_FOUND',
    InconsistentChanges: 'INCONSISTENT_CHANGES'
} as const;
export type BTAppElementBulkCreateInfoErrorValueEnum = typeof BTAppElementBulkCreateInfoErrorValueEnum[keyof typeof BTAppElementBulkCreateInfoErrorValueEnum];
