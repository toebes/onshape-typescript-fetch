...
export interface BTAssemblyPatternInfo {
     ...
     * @memberof BTAssemblyPatternInfo
     */
    type?: BTAssemblyPatternInfoTypeEnum;
}
 ...
 * @export
 */
export const BTAssemblyPatternInfoTypeEnum = {
    Linear: 'LINEAR',
    Circular: 'CIRCULAR',
    Unknown: 'UNKNOWN'
} as const;
export type BTAssemblyPatternInfoTypeEnum = typeof BTAssemblyPatternInfoTypeEnum[keyof typeof BTAssemblyPatternInfoTypeEnum];
