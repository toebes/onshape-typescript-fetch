...
export interface BTAssemblyInstanceDefinitionParams {
     ...
     * @memberof BTAssemblyInstanceDefinitionParams
     */
    includePartTypes?: Array<BTAssemblyInstanceDefinitionParamsIncludePartTypesEnum>;
    /**
     * 
     * @type {boolean}
     * @memberof BTAssemblyInstanceDefinitionParams
 ...
 * @export
 */
export const BTAssemblyInstanceDefinitionParamsIncludePartTypesEnum = {
    Parts: 'PARTS',
    Sketches: 'SKETCHES',
    Surfaces: 'SURFACES',
...
export type BTAssemblyInstanceDefinitionParamsIncludePartTypesEnum = typeof BTAssemblyInstanceDefinitionParamsIncludePartTypesEnum[keyof typeof BTAssemblyInstanceDefinitionParamsIncludePartTypesEnum];
...
export function BTAssemblyInstanceDefinitionParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTAssemblyInstanceDefinitionParams {
    ...
    return {
        ...
        'includePartTypes': !exists(json, 'includePartTypes') ? undefined : json['includePartTypes'],
...
export function BTAssemblyInstanceDefinitionParamsToJSON(value?: BTAssemblyInstanceDefinitionParams | null): any {
    ...
    return {
        ...
        'includePartTypes': value.includePartTypes,
