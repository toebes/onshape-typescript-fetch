...
export interface BTMParameterProgress3232AllOf {
     ...
     * @memberof BTMParameterProgress3232AllOf
     */
    status?: BTMParameterProgress3232AllOfStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof BTMParameterProgress3232AllOf
 ...
 * @export
 */
export const BTMParameterProgress3232AllOfStatusEnum = {
    Computed: 'COMPUTED',
    Stale: 'STALE',
    Computing: 'COMPUTING',
    Error: 'ERROR',
...
export type BTMParameterProgress3232AllOfStatusEnum = typeof BTMParameterProgress3232AllOfStatusEnum[keyof typeof BTMParameterProgress3232AllOfStatusEnum];
