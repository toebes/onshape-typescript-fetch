 ...
 * @export
 */
export const BTPartInstance81TypeEnum = {
    Part: 'PART',
    Sketch: 'SKETCH',
    Surface: 'SURFACE',
    Composite: 'COMPOSITE',
...
export type BTPartInstance81TypeEnum = typeof BTPartInstance81TypeEnum[keyof typeof BTPartInstance81TypeEnum];
