...
export interface BTAppElementContentInfo {
     ...
     * @memberof BTAppElementContentInfo
     */
    errorValue?: BTAppElementContentInfoErrorValueEnum;
}
 ...
 * @export
 */
export const BTAppElementContentInfoErrorValueEnum = {
    Ok: 'OK',
    TransactionConflict: 'TRANSACTION_CONFLICT',
    NotFound: 'NOT_FOUND',
    InconsistentChanges: 'INCONSISTENT_CHANGES'
} as const;
export type BTAppElementContentInfoErrorValueEnum = typeof BTAppElementContentInfoErrorValueEnum[keyof typeof BTAppElementContentInfoErrorValueEnum];
