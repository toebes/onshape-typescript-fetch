...
export interface BTMSketchConstraint2 {
     ...
     * @memberof BTMSketchConstraint2
     */
    constraintType?: BTMSketchConstraint2ConstraintTypeEnum;
    /**
     * 
     * @type {boolean}
     * @memberof BTMSketchConstraint2
 ...
 * @export
 */
export const BTMSketchConstraint2ConstraintTypeEnum = {
    None: 'NONE',
...
export type BTMSketchConstraint2ConstraintTypeEnum = typeof BTMSketchConstraint2ConstraintTypeEnum[keyof typeof BTMSketchConstraint2ConstraintTypeEnum];
...
export function BTMSketchConstraint2FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMSketchConstraint2 {
    ...
    return {
        ...
        'constraintType': !exists(json, 'constraintType') ? undefined : json['constraintType'],
