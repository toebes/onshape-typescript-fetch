 ...
 * @export
 */
export const BTNotice227LevelEnum = {
    Internal: 'INTERNAL',
    Error: 'ERROR',
    Warning: 'WARNING',
    Info: 'INFO',
...
export type BTNotice227LevelEnum = typeof BTNotice227LevelEnum[keyof typeof BTNotice227LevelEnum];

/**
 * @export
 */
export const BTNotice227TypeEnum = {
    Parse: 'PARSE',
    Semantic: 'SEMANTIC',
    Execution: 'EXECUTION',
    Modeling: 'MODELING',
...
export type BTNotice227TypeEnum = typeof BTNotice227TypeEnum[keyof typeof BTNotice227TypeEnum];
