...
import {
     BTParameterSpecIcon4779FromJSONTyped,
    BTParameterSpecIcon4779ToJSON,
     BTParameterSpecNotice3132FromJSONTyped,
    BTParameterSpecNotice3132ToJSON,
...
export function BTReadOnlyParameterSpec1889FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTReadOnlyParameterSpec1889 {
    ...
    if (!ignoreDiscriminator) {
        if (json['btType'] === 'BTParameterSpecIcon-4779') {
            return BTParameterSpecIcon4779FromJSONTyped(json, true);
        }
        if (json['btType'] === 'BTParameterSpecNotice-3132') {
            return BTParameterSpecNotice3132FromJSONTyped(json, true);
        }
...
export function BTReadOnlyParameterSpec1889ToJSON(value?: BTReadOnlyParameterSpec1889 | null): any {
    ...
    if (value.btType === 'BTParameterSpecIcon-4779') {
        return BTParameterSpecIcon4779ToJSON(value);
    }
    if (value.btType === 'BTParameterSpecNotice-3132') {
        return BTParameterSpecNotice3132ToJSON(value);
    }
