...
export function BTMSketchEntity3FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMSketchEntity3 {
    ...
    return {
        ...
        'combinedSketchEntityType': !exists(json, 'combinedSketchEntityType') ? undefined : CombinedSketchEntityTypeFromJSON(json['combinedSketchEntityType']),
...
export function BTMSketchEntity3SuperToJSON(value?: BTMSketchEntity3 | null): any {
    ...
    return {
        ...
        'btType': value.btType,
        'combinedSketchEntityType': CombinedSketchEntityTypeToJSON(value.combinedSketchEntityType),
