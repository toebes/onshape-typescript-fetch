 ...
 */
export function instanceOfBTMVariableStudioReference2764(
    value: object
): boolean {
    let isInstance = true;
...
export function BTMVariableStudioReference2764FromJSON(
    json: any
): BTMVariableStudioReference2764 {
    return BTMVariableStudioReference2764FromJSONTyped(json, false);
}

export function BTMVariableStudioReference2764FromJSONTyped(
    json: any,
    ...
    return {
        ...
        apiConfiguration: !exists(json, 'apiConfiguration')
            ? undefined
            : BTApiConfigurationFromJSON(json['apiConfiguration']),
        ...
        entireVariableStudio: !exists(json, 'entireVariableStudio')
            ? undefined
            : json['entireVariableStudio'],
        isAutomatic: !exists(json, 'isAutomatic')
            ? undefined
            : json['isAutomatic'],
        lockedState: !exists(json, 'lockedState')
            ? undefined
            : BTMParameter1FromJSON(json['lockedState']),
        microversionId: !exists(json, 'microversionId')
            ? undefined
            : BTMicroversionId366FromJSON(json['microversionId']),
        partialReference: !exists(json, 'partialReference')
            ? undefined
            : json['partialReference'],
        referenceId: !exists(json, 'referenceId')
            ? undefined
            : json['referenceId'],
        referenceNamespace: !exists(json, 'referenceNamespace')
            ? undefined
            : json['referenceNamespace'],
        referenceParameter: !exists(json, 'referenceParameter')
            ? undefined
            : BTMParameterReferenceWithConfiguration3028FromJSON(
                  json['referenceParameter']
              ),
        unsetAutomaticEdit: !exists(json, 'unsetAutomaticEdit')
            ? undefined
            : BTTreeEdit13FromJSON(json['unsetAutomaticEdit']),
        validRevisionReference: !exists(json, 'validRevisionReference')
            ? undefined
            : json['validRevisionReference'],
        variableNames: !exists(json, 'variableNames')
            ? undefined
            : json['variableNames'],
...
export function BTMVariableStudioReference2764ToJSON(
    value?: BTMVariableStudioReference2764 | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        referenceParameter: BTMParameterReferenceWithConfiguration3028ToJSON(
