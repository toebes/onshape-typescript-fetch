...
export interface BTWorkflowableObjectObserver {
     ...
     * @memberof BTWorkflowableObjectObserver
     */
    approvalState?: BTWorkflowableObjectObserverApprovalStateEnum;
    /**
     * 
     * @type {string}
     * @memberof BTWorkflowableObjectObserver
     ...
     * @memberof BTWorkflowableObjectObserver
     */
    entryType?: BTWorkflowableObjectObserverEntryTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof BTWorkflowableObjectObserver
 ...
 * @export
 */
export const BTWorkflowableObjectObserverApprovalStateEnum = {
    None: 'NONE',
    Approved: 'APPROVED',
    Rejected: 'REJECTED',
    Overridden: 'OVERRIDDEN'
} as const;
export type BTWorkflowableObjectObserverApprovalStateEnum = typeof BTWorkflowableObjectObserverApprovalStateEnum[keyof typeof BTWorkflowableObjectObserverApprovalStateEnum];

/**
 * @export
 */
export const BTWorkflowableObjectObserverEntryTypeEnum = {
    User: 'USER',
    Team: 'TEAM',
    Role: 'ROLE',
    Alias: 'ALIAS'
} as const;
export type BTWorkflowableObjectObserverEntryTypeEnum = typeof BTWorkflowableObjectObserverEntryTypeEnum[keyof typeof BTWorkflowableObjectObserverEntryTypeEnum];
...
export function BTWorkflowableObjectObserverFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTWorkflowableObjectObserver {
    ...
    return {
        ...
        'approvalState': !exists(json, 'approvalState') ? undefined : json['approvalState'],
