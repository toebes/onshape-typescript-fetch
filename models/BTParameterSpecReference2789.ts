...
import {
    ...
    BTParameterSpecReferencePartStudio1256ToJSON,
     BTParameterSpecReferenceVariableStudio1060FromJSONTyped,
    BTParameterSpecReferenceVariableStudio1060ToJSON,
...
export function BTParameterSpecReference2789FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTParameterSpecReference2789 {
    ...
    if (!ignoreDiscriminator) {
        ...
        if (json['btType'] === 'BTParameterSpecReferenceVariableStudio-1060') {
            return BTParameterSpecReferenceVariableStudio1060FromJSONTyped(json, true);
        }
...
export function BTParameterSpecReference2789ToJSON(value?: BTParameterSpecReference2789 | null): any {
    ...
    if (value.btType === 'BTParameterSpecReferenceVariableStudio-1060') {
        return BTParameterSpecReferenceVariableStudio1060ToJSON(value);
    }
