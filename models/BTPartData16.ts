...
export interface BTPartData16 {
     ...
     */
    bestAvailableTessellationSetting?: BTPartData16BestAvailableTessellationSettingEnum;
    /**
     * 
     * @type {number}
     * @memberof BTPartData16
     ...
     * @memberof BTPartData16
     */
    userTessellationSetting?: BTPartData16UserTessellationSettingEnum;
}
 ...
 * @export
 */
export const BTPartData16BestAvailableTessellationSettingEnum = {
    Auto: 'AUTO',
    Coarse: 'COARSE',
    Medium: 'MEDIUM',
    Fine: 'FINE',
...
export type BTPartData16BestAvailableTessellationSettingEnum = typeof BTPartData16BestAvailableTessellationSettingEnum[keyof typeof BTPartData16BestAvailableTessellationSettingEnum];

/**
 * @export
 */
export const BTPartData16UserTessellationSettingEnum = {
    Auto: 'AUTO',
    Coarse: 'COARSE',
    Medium: 'MEDIUM',
    Fine: 'FINE',
...
export type BTPartData16UserTessellationSettingEnum = typeof BTPartData16UserTessellationSettingEnum[keyof typeof BTPartData16UserTessellationSettingEnum];
...
export function BTPartData16FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTPartData16 {
    ...
    return {
        ...
        'bestAvailableTessellationSetting': !exists(json, 'bestAvailableTessellationSetting') ? undefined : json['bestAvailableTessellationSetting'],
        ...
        'userTessellationSetting': !exists(json, 'userTessellationSetting') ? undefined : json['userTessellationSetting'],
    };
}
...
export function BTPartData16ToJSON(value?: BTPartData16 | null): any {
    ...
    return {
        ...
        'bestAvailableTessellationSetting': value.bestAvailableTessellationSetting,
        ...
        'userTessellationSetting': value.userTessellationSetting,
    };
}
