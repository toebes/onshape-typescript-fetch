...
export interface BTAclEntryInfo {
     ...
     * @memberof BTAclEntryInfo
     */
    entryState?: BTAclEntryInfoEntryStateEnum;
    /**
     * 
     * @type {number}
     * @memberof BTAclEntryInfo
 ...
 * @export
 */
export const BTAclEntryInfoEntryStateEnum = {
    Deleted: 'DELETED',
    Active: 'ACTIVE',
    Inactive: 'INACTIVE',
    Requested: 'REQUESTED',
...
export type BTAclEntryInfoEntryStateEnum = typeof BTAclEntryInfoEntryStateEnum[keyof typeof BTAclEntryInfoEntryStateEnum];
...
export function BTAclEntryInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTAclEntryInfo {
    ...
    return {
        ...
        'entryState': !exists(json, 'entryState') ? undefined : json['entryState'],
