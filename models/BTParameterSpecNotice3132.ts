 ...
 * 
 * @export
 * @interface BTParameterSpecNotice3132
 */
export interface BTParameterSpecNotice3132 extends BTReadOnlyParameterSpec1889 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTParameterSpecNotice3132
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTParameterSpecNotice3132 interface.
 */
export function instanceOfBTParameterSpecNotice3132(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTParameterSpecNotice3132FromJSON(json: any): BTParameterSpecNotice3132 {
    return BTParameterSpecNotice3132FromJSONTyped(json, false);
}

export function BTParameterSpecNotice3132FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTParameterSpecNotice3132 {
...
export function BTParameterSpecNotice3132ToJSON(value?: BTParameterSpecNotice3132 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
