...
export interface BTAssemblyPartInfo {
     ...
     */
    bodyType?: BTAssemblyPartInfoBodyTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof BTAssemblyPartInfo
 ...
 * @export
 */
export const BTAssemblyPartInfoBodyTypeEnum = {
    Solid: 'solid',
    Sheet: 'sheet',
    Composite: 'composite'
} as const;
export type BTAssemblyPartInfoBodyTypeEnum = typeof BTAssemblyPartInfoBodyTypeEnum[keyof typeof BTAssemblyPartInfoBodyTypeEnum];
