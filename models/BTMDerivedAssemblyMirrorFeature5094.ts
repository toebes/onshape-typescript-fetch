 ...
 * 
 * @export
 * @interface BTMDerivedAssemblyMirrorFeature5094
 */
export interface BTMDerivedAssemblyMirrorFeature5094 {
    /**
     * 
     * @type {boolean}
     * @memberof BTMDerivedAssemblyMirrorFeature5094
     */
...
/**
 * Check if a given object implements the BTMDerivedAssemblyMirrorFeature5094 interface.
 */
export function instanceOfBTMDerivedAssemblyMirrorFeature5094(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTMDerivedAssemblyMirrorFeature5094FromJSON(json: any): BTMDerivedAssemblyMirrorFeature5094 {
    return BTMDerivedAssemblyMirrorFeature5094FromJSONTyped(json, false);
}

export function BTMDerivedAssemblyMirrorFeature5094FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMDerivedAssemblyMirrorFeature5094 {
...
export function BTMDerivedAssemblyMirrorFeature5094ToJSON(value?: BTMDerivedAssemblyMirrorFeature5094 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
