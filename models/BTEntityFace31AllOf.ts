...
export interface BTEntityFace31AllOf {
     ...
     * @memberof BTEntityFace31AllOf
     */
    surfaceType?: BTEntityFace31AllOfSurfaceTypeEnum;
    /**
     * 
     * @type {BTImmutableFloatArray}
     * @memberof BTEntityFace31AllOf
 ...
 * @export
 */
export const BTEntityFace31AllOfSurfaceTypeEnum = {
    Plane: 'PLANE',
    Cylinder: 'CYLINDER',
    Cone: 'CONE',
    Sphere: 'SPHERE',
...
export type BTEntityFace31AllOfSurfaceTypeEnum = typeof BTEntityFace31AllOfSurfaceTypeEnum[keyof typeof BTEntityFace31AllOfSurfaceTypeEnum];
