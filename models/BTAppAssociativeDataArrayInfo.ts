...
export interface BTAppAssociativeDataArrayInfo {
     ...
     * @memberof BTAppAssociativeDataArrayInfo
     */
    errorValue?: BTAppAssociativeDataArrayInfoErrorValueEnum;
    /**
     * 
 ...
 * @export
 */
export const BTAppAssociativeDataArrayInfoErrorValueEnum = {
    Ok: 'OK',
    TransactionConflict: 'TRANSACTION_CONFLICT',
    NotFound: 'NOT_FOUND',
    InconsistentChanges: 'INCONSISTENT_CHANGES'
} as const;
export type BTAppAssociativeDataArrayInfoErrorValueEnum = typeof BTAppAssociativeDataArrayInfoErrorValueEnum[keyof typeof BTAppAssociativeDataArrayInfoErrorValueEnum];
