...
export interface BTPStatementConstantDeclaration273AllOf {
     ...
     * @memberof BTPStatementConstantDeclaration273AllOf
     */
    standardType?: BTPStatementConstantDeclaration273AllOfStandardTypeEnum;
    /**
     * 
     * @type {BTPTypeName290}
     * @memberof BTPStatementConstantDeclaration273AllOf
 ...
 * @export
 */
export const BTPStatementConstantDeclaration273AllOfStandardTypeEnum = {
    Undefined: 'UNDEFINED',
    Boolean: 'BOOLEAN',
    Number: 'NUMBER',
    String: 'STRING',
...
export type BTPStatementConstantDeclaration273AllOfStandardTypeEnum = typeof BTPStatementConstantDeclaration273AllOfStandardTypeEnum[keyof typeof BTPStatementConstantDeclaration273AllOfStandardTypeEnum];
