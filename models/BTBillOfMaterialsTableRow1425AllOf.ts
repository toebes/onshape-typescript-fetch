...
export interface BTBillOfMaterialsTableRow1425AllOf {
     ...
     * @memberof BTBillOfMaterialsTableRow1425AllOf
     */
    exclusionStatus?: BTBillOfMaterialsTableRow1425AllOfExclusionStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof BTBillOfMaterialsTableRow1425AllOf
     */
    expansionStatus?: BTBillOfMaterialsTableRow1425AllOfExpansionStatusEnum;
    /**
     * 
     * @type {number}
     * @memberof BTBillOfMaterialsTableRow1425AllOf
 ...
 * @export
 */
export const BTBillOfMaterialsTableRow1425AllOfExclusionStatusEnum = {
    NotExcluded: 'NOT_EXCLUDED',
    ParentExcluded: 'PARENT_EXCLUDED',
    Excluded: 'EXCLUDED',
    Unknown: 'UNKNOWN'
} as const;
export type BTBillOfMaterialsTableRow1425AllOfExclusionStatusEnum = typeof BTBillOfMaterialsTableRow1425AllOfExclusionStatusEnum[keyof typeof BTBillOfMaterialsTableRow1425AllOfExclusionStatusEnum];

/**
 * @export
 */
export const BTBillOfMaterialsTableRow1425AllOfExpansionStatusEnum = {
    NotExpandable: 'NOT_EXPANDABLE',
    Expanded: 'EXPANDED',
    Collapsed: 'COLLAPSED',
    Unknown: 'UNKNOWN'
} as const;
export type BTBillOfMaterialsTableRow1425AllOfExpansionStatusEnum = typeof BTBillOfMaterialsTableRow1425AllOfExpansionStatusEnum[keyof typeof BTBillOfMaterialsTableRow1425AllOfExpansionStatusEnum];
