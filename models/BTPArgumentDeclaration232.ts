...
export interface BTPArgumentDeclaration232 {
     ...
     * @memberof BTPArgumentDeclaration232
     */
    documentationType?: BTPArgumentDeclaration232DocumentationTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof BTPArgumentDeclaration232
     ...
     * @memberof BTPArgumentDeclaration232
     */
    standardType?: BTPArgumentDeclaration232StandardTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof BTPArgumentDeclaration232
 ...
 * @export
 */
export const BTPArgumentDeclaration232DocumentationTypeEnum = {
    Function: 'FUNCTION',
    Predicate: 'PREDICATE',
    Constant: 'CONSTANT',
    Enum: 'ENUM',
...
export type BTPArgumentDeclaration232DocumentationTypeEnum = typeof BTPArgumentDeclaration232DocumentationTypeEnum[keyof typeof BTPArgumentDeclaration232DocumentationTypeEnum];

/**
 * @export
 */
export const BTPArgumentDeclaration232StandardTypeEnum = {
    Undefined: 'UNDEFINED',
    Boolean: 'BOOLEAN',
    Number: 'NUMBER',
    String: 'STRING',
...
export type BTPArgumentDeclaration232StandardTypeEnum = typeof BTPArgumentDeclaration232StandardTypeEnum[keyof typeof BTPArgumentDeclaration232StandardTypeEnum];
