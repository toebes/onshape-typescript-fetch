 ...
 * 
 * @export
 * @interface BTCosmeticThreadMetadata3248
 */
export interface BTCosmeticThreadMetadata3248 extends BTDomainSpecificMetadata961 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTCosmeticThreadMetadata3248
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTCosmeticThreadMetadata3248 interface.
 */
export function instanceOfBTCosmeticThreadMetadata3248(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTCosmeticThreadMetadata3248FromJSON(json: any): BTCosmeticThreadMetadata3248 {
    return BTCosmeticThreadMetadata3248FromJSONTyped(json, false);
}

export function BTCosmeticThreadMetadata3248FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTCosmeticThreadMetadata3248 {
...
export function BTCosmeticThreadMetadata3248ToJSON(value?: BTCosmeticThreadMetadata3248 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
