...
export interface BTElementMergeInfo {
     ...
     * @memberof BTElementMergeInfo
     */
    elementType?: BTElementMergeInfoElementTypeEnum;
    /**
     * 
     * @type {boolean}
     * @memberof BTElementMergeInfo
     ...
     * @memberof BTElementMergeInfo
     */
    sourceElementStatus?: BTElementMergeInfoSourceElementStatusEnum;
    /**
     * 
     * @type {Date}
     * @memberof BTElementMergeInfo
     ...
     * @memberof BTElementMergeInfo
     */
    targetElementStatus?: BTElementMergeInfoTargetElementStatusEnum;
    /**
     * 
     * @type {Date}
     * @memberof BTElementMergeInfo
 ...
 * @export
 */
export const BTElementMergeInfoElementTypeEnum = {
...
export type BTElementMergeInfoElementTypeEnum = typeof BTElementMergeInfoElementTypeEnum[keyof typeof BTElementMergeInfoElementTypeEnum];

/**
 * @export
 */
export const BTElementMergeInfoSourceElementStatusEnum = {
    Created: 'CREATED',
    Deleted: 'DELETED',
    Edits: 'EDITS',
...
export type BTElementMergeInfoSourceElementStatusEnum = typeof BTElementMergeInfoSourceElementStatusEnum[keyof typeof BTElementMergeInfoSourceElementStatusEnum];

/**
 * @export
 */
export const BTElementMergeInfoTargetElementStatusEnum = {
    Created: 'CREATED',
    Deleted: 'DELETED',
    Edits: 'EDITS',
    NotOnThisBranch: 'NOT_ON_THIS_BRANCH',
...
export type BTElementMergeInfoTargetElementStatusEnum = typeof BTElementMergeInfoTargetElementStatusEnum[keyof typeof BTElementMergeInfoTargetElementStatusEnum];
...
export function BTElementMergeInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTElementMergeInfo {
    ...
    return {
        ...
        'sourceElementStatus': !exists(json, 'sourceElementStatus') ? undefined : json['sourceElementStatus'],
        ...
        'targetElementStatus': !exists(json, 'targetElementStatus') ? undefined : json['targetElementStatus'],
...
export function BTElementMergeInfoToJSON(value?: BTElementMergeInfo | null): any {
    ...
    return {
        ...
        'sourceElementStatus': value.sourceElementStatus,
        ...
        'targetElementStatus': value.targetElementStatus,
