...
export interface BTApiTableColumn3141 {
     ...
     * @memberof BTApiTableColumn3141
     */
    textAlignment?: BTApiTableColumn3141TextAlignmentEnum;
}
 ...
 * @export
 */
export const BTApiTableColumn3141TextAlignmentEnum = {
    Left: 'LEFT',
    Center: 'CENTER',
    Right: 'RIGHT',
    Unknown: 'UNKNOWN'
} as const;
export type BTApiTableColumn3141TextAlignmentEnum = typeof BTApiTableColumn3141TextAlignmentEnum[keyof typeof BTApiTableColumn3141TextAlignmentEnum];
...
export function BTApiTableColumn3141FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTApiTableColumn3141 {
    ...
    return {
        ...
        'textAlignment': !exists(json, 'textAlignment') ? undefined : json['textAlignment'],
    };
}
