 ...
 * 
 * @export
 * @interface BTAnnotationWeldDisplayData4919
 */
export interface BTAnnotationWeldDisplayData4919 extends BTAnnotationDisplayData3225 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTAnnotationWeldDisplayData4919
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTAnnotationWeldDisplayData4919 interface.
 */
export function instanceOfBTAnnotationWeldDisplayData4919(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTAnnotationWeldDisplayData4919FromJSON(json: any): BTAnnotationWeldDisplayData4919 {
    return BTAnnotationWeldDisplayData4919FromJSONTyped(json, false);
}

export function BTAnnotationWeldDisplayData4919FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTAnnotationWeldDisplayData4919 {
...
export function BTAnnotationWeldDisplayData4919ToJSON(value?: BTAnnotationWeldDisplayData4919 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
