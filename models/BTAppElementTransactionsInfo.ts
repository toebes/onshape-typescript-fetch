...
export interface BTAppElementTransactionsInfo {
     ...
     * @memberof BTAppElementTransactionsInfo
     */
    errorValue?: BTAppElementTransactionsInfoErrorValueEnum;
}
 ...
 * @export
 */
export const BTAppElementTransactionsInfoErrorValueEnum = {
    Ok: 'OK',
    TransactionConflict: 'TRANSACTION_CONFLICT',
    NotFound: 'NOT_FOUND',
    InconsistentChanges: 'INCONSISTENT_CHANGES'
} as const;
export type BTAppElementTransactionsInfoErrorValueEnum = typeof BTAppElementTransactionsInfoErrorValueEnum[keyof typeof BTAppElementTransactionsInfoErrorValueEnum];
