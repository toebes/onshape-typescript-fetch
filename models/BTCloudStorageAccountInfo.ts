...
export function BTCloudStorageAccountInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTCloudStorageAccountInfo {
    ...
    return {
        ...
        'lastAuthenticated': !exists(json, 'lastAuthenticated') ? undefined : (new Date(json['lastAuthenticated'])),
    };
}
...
export function BTCloudStorageAccountInfoToJSON(value?: BTCloudStorageAccountInfo | null): any {
    ...
    return {
        ...
        'lastAuthenticated': value.lastAuthenticated === undefined ? undefined : (value.lastAuthenticated.toISOString()),
    };
}
