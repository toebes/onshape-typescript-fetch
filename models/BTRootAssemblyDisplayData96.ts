...
export interface BTRootAssemblyDisplayData96 {
    ...
    /**
     * 
     * @type {Array<BTAssemblyFeatureDisplayData1783>}
     * @memberof BTRootAssemblyDisplayData96
     */
     ...
     * @memberof BTRootAssemblyDisplayData96
     */
    fullElementIdToReferencedSketchIds?: { [key: string]: Set<string>; };
    /**
     * 
...
export function BTRootAssemblyDisplayData96FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTRootAssemblyDisplayData96 {
    ...
    return {
        ...
        'assemblyFeatures': !exists(json, 'assemblyFeatures') ? undefined : ((json['assemblyFeatures'] as Array<any>).map(BTAssemblyFeatureDisplayData1783FromJSON)),
        'btType': !exists(json, 'btType') ? undefined : json['btType'],
        'buildDurationMillis': !exists(json, 'buildDurationMillis') ? undefined : json['buildDurationMillis'],
        'deletedAssemblyFeatures': !exists(json, 'deletedAssemblyFeatures') ? undefined : json['deletedAssemblyFeatures'],
        ...
        'fullElementIdToReferencedSketchIds': !exists(json, 'fullElementIdToReferencedSketchIds') ? undefined : json['fullElementIdToReferencedSketchIds'],
...
export function BTRootAssemblyDisplayData96ToJSON(value?: BTRootAssemblyDisplayData96 | null): any {
    ...
    return {
        ...
        'assemblyFeatures': value.assemblyFeatures === undefined ? undefined : ((value.assemblyFeatures as Array<any>).map(BTAssemblyFeatureDisplayData1783ToJSON)),
        'btType': value.btType,
        'buildDurationMillis': value.buildDurationMillis,
        'deletedAssemblyFeatures': value.deletedAssemblyFeatures,
        ...
        'fullElementIdToReferencedSketchIds': value.fullElementIdToReferencedSketchIds,
