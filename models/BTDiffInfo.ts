...
export interface BTDiffInfo {
     ...
     * @memberof BTDiffInfo
     */
    entityType?: BTDiffInfoEntityTypeEnum;
    /**
     * 
     * @type {Array<string>}
     * @memberof BTDiffInfo
 ...
 * @export
 */
export const BTDiffInfoEntityTypeEnum = {
    Parts: 'parts',
    Sketches: 'sketches',
    Points: 'points',
...
export type BTDiffInfoEntityTypeEnum = typeof BTDiffInfoEntityTypeEnum[keyof typeof BTDiffInfoEntityTypeEnum];

/**
 * @export
 */
export const BTDiffInfoTypeEnum = {
    None: 'NONE',
    Moved: 'MOVED',
    Modified: 'MODIFIED',
...
export type BTDiffInfoTypeEnum = typeof BTDiffInfoTypeEnum[keyof typeof BTDiffInfoTypeEnum];
