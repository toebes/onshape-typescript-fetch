 ...
 * 
 * @export
 * @interface BTPName261AllOf
 */
export interface BTPName261AllOf {
    /**
     * 
     * @type {string}
     * @memberof BTPName261AllOf
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTPName261AllOf interface.
 */
export function instanceOfBTPName261AllOf(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTPName261AllOfFromJSON(json: any): BTPName261AllOf {
    return BTPName261AllOfFromJSONTyped(json, false);
}

export function BTPName261AllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTPName261AllOf {
...
export function BTPName261AllOfToJSON(value?: BTPName261AllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
