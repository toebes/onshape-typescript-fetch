...
export interface BTPStatementLoopForIn279AllOf {
     ...
     * @memberof BTPStatementLoopForIn279AllOf
     */
    standardTypes?: Array<BTPStatementLoopForIn279AllOfStandardTypesEnum>;
    /**
     * 
     * @type {Array<string>}
     * @memberof BTPStatementLoopForIn279AllOf
 ...
 * @export
 */
export const BTPStatementLoopForIn279AllOfStandardTypesEnum = {
    Undefined: 'UNDEFINED',
    Boolean: 'BOOLEAN',
    Number: 'NUMBER',
    String: 'STRING',
...
export type BTPStatementLoopForIn279AllOfStandardTypesEnum = typeof BTPStatementLoopForIn279AllOfStandardTypesEnum[keyof typeof BTPStatementLoopForIn279AllOfStandardTypesEnum];
...
export function BTPStatementLoopForIn279AllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTPStatementLoopForIn279AllOf {
    ...
    return {
        ...
        'standardTypes': !exists(json, 'standardTypes') ? undefined : json['standardTypes'],
...
export function BTPStatementLoopForIn279AllOfToJSON(value?: BTPStatementLoopForIn279AllOf | null): any {
    ...
    return {
        ...
        'standardTypes': value.standardTypes,
