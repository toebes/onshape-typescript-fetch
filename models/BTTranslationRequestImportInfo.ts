 ...
 * 
 * @export
 * @interface BTTranslationRequestImportInfo
 */
export interface BTTranslationRequestImportInfo {
    /**
     * 
     * @type {string}
     * @memberof BTTranslationRequestImportInfo
     */
    documentId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTTranslationRequestImportInfo interface.
 */
export function instanceOfBTTranslationRequestImportInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTTranslationRequestImportInfoFromJSON(json: any): BTTranslationRequestImportInfo {
    return BTTranslationRequestImportInfoFromJSONTyped(json, false);
}

export function BTTranslationRequestImportInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTTranslationRequestImportInfo {
...
export function BTTranslationRequestImportInfoToJSON(value?: BTTranslationRequestImportInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
