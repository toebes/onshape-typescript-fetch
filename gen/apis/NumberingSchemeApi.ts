 ...
 * no description
 */
export class NumberingSchemeApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param did 
     */
    public async nextNumbers(bTNextPartNumbersParam: BTNextPartNumbersParam, cid?: string, did?: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (bTNextPartNumbersParam === null || bTNextPartNumbersParam === undefined) {
            throw new RequiredError("NumberingSchemeApi", "nextNumbers", "bTNextPartNumbersParam");
        }
        ...
        // Path Params
        const localVarPath = '/numberingscheme/nextnumbers';
...
export class NumberingSchemeApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to nextNumbers
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async nextNumbersWithHttpInfo(response: ResponseContext): Promise<HttpInfo< void>> {
