...
export class BTRevisionCustomData2090 extends BTReferenceCustomData1551 {
    'btType'?: string;
    'partNumber'?: string;
    'revision'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTRevisionCustomData2090.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTRevisionCustomData2090";
    }
}
