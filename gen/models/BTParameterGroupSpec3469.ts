...
export class BTParameterGroupSpec3469 {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "collapsedByDefault",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "drivingParameterId",
            "baseName": "drivingParameterId",
            "type": "string",
            "format": ""
        },
        {
        ...
        {
            "name": "groupOrParameterIds",
            "baseName": "groupOrParameterIds",
            "type": "Array<string>",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return BTParameterGroupSpec3469.attributeTypeMap;
    }
