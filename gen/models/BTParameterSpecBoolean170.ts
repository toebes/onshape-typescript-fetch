...
export class BTParameterSpecBoolean170 extends BTParameterSpec6 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecBoolean170.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecBoolean170";
    }
}
