...
export class BTNonAlignedBoundingBox4180 extends BTBoundingBox1052 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTNonAlignedBoundingBox4180.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTNonAlignedBoundingBox4180";
    }
}
