...
export class BTSpunDescription657 extends BTSurfaceDescription1564 {
    'btType'?: string;
    'axis'?: BTVector3d389;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTSpunDescription657.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTSpunDescription657";
    }
}
