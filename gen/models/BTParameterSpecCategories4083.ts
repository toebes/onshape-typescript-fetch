...
export class BTParameterSpecCategories4083 extends BTParameterSpecMultiEnum3118 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "categoryIdToMetadataTypes",
            "baseName": "categoryIdToMetadataTypes",
            "type": "{ [key: string]: Array<number>; }",
            "format": "int32"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecCategories4083.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecCategories4083";
    }
}
