...
export class BTPFunctionOrPredicateDeclaration247 extends BTPProcedureDeclarationBase266 {
    'btType'?: string;
    'name'?: BTPIdentifier8;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPFunctionOrPredicateDeclaration247.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPProcedureDeclarationBase266";
        this.btType = "BTPFunctionOrPredicateDeclaration247";
    }
}
