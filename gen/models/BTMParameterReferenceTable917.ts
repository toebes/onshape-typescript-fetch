...
export class BTMParameterReferenceTable917 extends BTMParameterReferenceBlob3281 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMParameterReferenceTable917.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMParameterReferenceTable917";
    }
}
