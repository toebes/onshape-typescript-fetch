...
export class BTMConfigurationParameterQuantity1826 extends BTMConfigurationParameter819 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "rangeAndDefault",
            "baseName": "rangeAndDefault",
            "type": "BTQuantityRange181",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMConfigurationParameterQuantity1826.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMConfigurationParameterQuantity1826";
    }
}
