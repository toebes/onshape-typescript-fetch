...
export class BTParameterSpecStringWithTolerances2535 extends BTReadOnlyParameterSpec1889 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecStringWithTolerances2535.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecStringWithTolerances2535";
    }
}
