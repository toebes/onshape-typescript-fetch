...
export class BTBaseEntityAppearanceEntry3607 {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "affectedDeterministicIds",
            "baseName": "affectedDeterministicIds",
            "type": "Array<string>",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return BTBaseEntityAppearanceEntry3607.attributeTypeMap;
    }
