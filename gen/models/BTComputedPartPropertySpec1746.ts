...
export class BTComputedPartPropertySpec1746 extends BTFeatureSpec129 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "computedPartPropertySpecId",
            "baseName": "computedPartPropertySpecId",
            "type": "string",
            "format": ""
        },
        {
            "name": "propertyFunctionReturnType",
            "baseName": "propertyFunctionReturnType",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTComputedPartPropertySpec1746.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTComputedPartPropertySpec1746";
    }
}
