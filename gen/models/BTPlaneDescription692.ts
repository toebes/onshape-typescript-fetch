...
export class BTPlaneDescription692 extends BTSurfaceDescription1564 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "isOrientedWithFace",
            "baseName": "isOrientedWithFace",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPlaneDescription692.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPlaneDescription692";
    }
}
