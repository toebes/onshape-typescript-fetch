...
export class BTMetadataElementInfo extends BTMetadataObjectInfo {
    'elementId'?: string;
    'elementType'?: number;
    'mimeType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMetadataElementInfo.attributeTypeMap);
    }

    public constructor() {
        super();
        this.jsonType = "BTMetadataElementInfo";
    }
}
