...
export class BTConfiguredPartProperties2645 {
    'btType'?: string;
    'nodeId'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "propertyIdToConfiguredTable",
            "baseName": "propertyIdToConfiguredTable",
            "type": "{ [key: string]: BTPartWithConfiguredProperties2163; }",
            "format": ""
        },
        {
            "name": "synchronizeToSingleEnumInput",
            "baseName": "synchronizeToSingleEnumInput",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTConfiguredPartProperties2645.attributeTypeMap;
    }
