...
export class BTPStatementCompressedQuery1237 extends BTPStatement269 {
    'btType'?: string;
    'query'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementCompressedQuery1237.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementCompressedQuery1237";
    }
}
