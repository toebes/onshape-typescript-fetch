...
export class BTParametricInstance2641 extends BTInstanceBase2263 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "instanceControlNodes",
            "baseName": "instanceControlNodes",
            "type": "Array<BTInstanceControlNode750>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParametricInstance2641.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTInstanceBase2263";
        this.btType = "BTParametricInstance2641";
    }
}
