...
export class BTVersionOrWorkspaceMergeInfo {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "mergeStrategyElementOverrides",
    ...
    static getAttributeTypeMap() {
        return BTVersionOrWorkspaceMergeInfo.attributeTypeMap;
    }
