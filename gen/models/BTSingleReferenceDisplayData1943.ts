...
export class BTSingleReferenceDisplayData1943 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "contextWorkspaceId",
            "baseName": "contextWorkspaceId",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return BTSingleReferenceDisplayData1943.attributeTypeMap;
    }

    public constructor() {
        this.btType = "BTSingleReferenceDisplayData1943";
    }
}
