...
export class BTUserSummaryInfo extends BTUserDetailSummaryInfo {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "personalMessageAllowed",
            "baseName": "personalMessageAllowed",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTUserSummaryInfo.attributeTypeMap);
    }

    public constructor() {
        super();
        this.jsonType = "BTUserSummaryInfo";
    }
}
