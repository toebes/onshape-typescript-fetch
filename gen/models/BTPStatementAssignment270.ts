...
export class BTPStatementAssignment270 extends BTPStatement269 {
    'btType'?: string;
    'lvalue'?: BTPLValue249;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementAssignment270.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementAssignment270";
    }
}
