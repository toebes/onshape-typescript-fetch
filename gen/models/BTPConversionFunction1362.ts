...
export class BTPConversionFunction1362 extends BTPProcedureDeclarationBase266 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPConversionFunction1362.attributeTypeMap);
    }
