...
export class BTPTypeNameStandard291 extends BTPTypeName290 {
    'btType'?: string;
    'type'?: GBTPType;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPTypeNameStandard291.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPTypeNameStandard291";
    }
}
