...
export class BTMMeshPointQuery1183 extends BTMIndividualQueryWithOccurrenceBase904 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMMeshPointQuery1183.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMMeshPointQuery1183";
    }
}
