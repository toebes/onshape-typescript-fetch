...
export class BTExportModelBodiesResponse734 {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "nodeIdToReferencedProperty",
            "baseName": "nodeIdToReferencedProperty",
            "type": "{ [key: string]: BTExportModelProperties3216; }",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTExportModelBodiesResponse734.attributeTypeMap;
    }
