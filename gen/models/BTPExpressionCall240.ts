...
export class BTPExpressionCall240 extends BTPExpression9 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "functionNameString",
            "type": "string",
            "format": ""
        },
        {
            "name": "isArrowCall",
            "baseName": "isArrowCall",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionCall240.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionCall240";
    }
}
