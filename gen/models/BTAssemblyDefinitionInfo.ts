...
export class BTAssemblyDefinitionInfo {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "partStudioFeatures",
            "baseName": "partStudioFeatures",
        ...
        {
            "name": "rootAssembly",
            "baseName": "rootAssembly",
            "type": "BTRootAssemblyInfo",
            "format": ""
        },
        {
            "name": "subAssemblies",
            "baseName": "subAssemblies",
            "type": "Array<BTSubAssemblyInfo>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTAssemblyDefinitionInfo.attributeTypeMap;
    }
