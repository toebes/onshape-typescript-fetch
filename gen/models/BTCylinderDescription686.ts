...
export class BTCylinderDescription686 extends BTSurfaceDescription1564 {
    'btType'?: string;
    'axis'?: BTVector3d389;
    'radius'?: number;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTCylinderDescription686.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTCylinderDescription686";
    }
}
