...
export class BTTableColumnSpec1967 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "defaultCellSpec",
            "baseName": "defaultCellSpec",
            "type": "BTParameterSpec6",
            "format": ""
        },
        {
            "name": "defaultColumnWidthUnits",
            "baseName": "defaultColumnWidthUnits",
            "type": "GBTTableColumnWidthUnits",
            "format": ""
        },
        {
            "name": "defaultColumnWidthValue",
            "baseName": "defaultColumnWidthValue",
            "type": "number",
            "format": "int32"
        },
        {
            "name": "defaultHeaderName",
            "baseName": "defaultHeaderName",
            "type": "string",
            "format": ""
        },
        {
            "name": "defaultTextAlignment",
            "baseName": "defaultTextAlignment",
    ...
    static getAttributeTypeMap() {
        return BTTableColumnSpec1967.attributeTypeMap;
    }
