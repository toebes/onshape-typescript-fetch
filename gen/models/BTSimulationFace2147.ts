...
export class BTSimulationFace2147 extends BTEntityFace31 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "sampleTrianglePointIndices",
            "baseName": "sampleTrianglePointIndices",
            "type": "BTImmutableIntArray",
            "format": ""
        },
        {
            "name": "triangleNormalIndices",
            "baseName": "triangleNormalIndices",
            "type": "BTImmutableIntArray",
            "format": ""
        },
        {
            "name": "trianglePointIndices",
            "baseName": "trianglePointIndices",
            "type": "BTImmutableIntArray",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTSimulationFace2147.attributeTypeMap);
    }
