...
export class BTSurfaceDescription1564 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "directionOrientedWithFace",
            "baseName": "directionOrientedWithFace",
            "type": "BTVector3d389",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return BTSurfaceDescription1564.attributeTypeMap;
    }

    public constructor() {
        this.btType = "BTSurfaceDescription1564";
    }
}
