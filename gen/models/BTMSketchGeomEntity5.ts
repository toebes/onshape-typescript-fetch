...
export class BTMSketchGeomEntity5 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "isFromEndpointSplineHandle",
            "baseName": "isFromEndpointSplineHandle",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return BTMSketchGeomEntity5.attributeTypeMap;
    }

    public constructor() {
        this.btType = "BTMSketchGeomEntity5";
    }
}
