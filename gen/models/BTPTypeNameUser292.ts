...
export class BTPTypeNameUser292 extends BTPTypeName290 {
    'btType'?: string;
    'type'?: BTPName261;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPTypeNameUser292.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPTypeNameUser292";
    }
}
