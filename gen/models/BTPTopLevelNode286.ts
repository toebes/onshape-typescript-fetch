...
export class BTPTopLevelNode286 extends BTPNode7 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPTopLevelNode286.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPTopLevelNode286";
        this.btType = "BTPTopLevelNode286";
    }
}
