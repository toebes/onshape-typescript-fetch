...
export class BTTableSpec915 extends BTFeatureSpec129 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "isComputedPropertyTable",
            "baseName": "isComputedPropertyTable",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTTableSpec915.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTTableSpec915";
    }
}
