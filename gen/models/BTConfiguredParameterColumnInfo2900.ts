...
export class BTConfiguredParameterColumnInfo2900 extends BTConfiguredValuesColumnInfo1025 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "innerParameterLocation",
            "baseName": "innerParameterLocation",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTConfiguredParameterColumnInfo2900.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTConfiguredValuesColumnInfo1025";
    }
}
