...
export class BTPLiteralNumber258 extends BTPLiteral253 {
    'btType'?: string;
    'integer'?: boolean;
    'text'?: string;
    'value'?: number;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPLiteralNumber258.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPLiteralNumber258";
    }
}
