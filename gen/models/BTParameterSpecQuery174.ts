...
export class BTParameterSpecQuery174 extends BTParameterSpec6 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "additionalBoxSelectFilter",
            "baseName": "additionalBoxSelectFilter",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecQuery174.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecQuery174";
    }
}
