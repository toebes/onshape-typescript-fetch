...
export class BTClassroomInfo extends BTGlobalTreeNodeInfo {
    'educator'?: boolean;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "numberOfAssignments",
            "type": "number",
            "format": "int64"
        },
        {
            "name": "numberOfMembers",
            "baseName": "numberOfMembers",
            "type": "number",
            "format": "int64"
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTClassroomInfo.attributeTypeMap);
    }

    public constructor() {
        super();
        this.jsonType = "BTClassroomInfo";
    }
}
