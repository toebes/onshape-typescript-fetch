...
export class BTMateOccurrenceData1671 extends BTFeatureOccurrenceData775 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMateOccurrenceData1671.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMateOccurrenceData1671";
    }
}
