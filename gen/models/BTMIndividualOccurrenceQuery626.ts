...
export class BTMIndividualOccurrenceQuery626 extends BTMIndividualQueryWithOccurrenceBase904 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMIndividualOccurrenceQuery626.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMIndividualOccurrenceQuery626";
    }
}
