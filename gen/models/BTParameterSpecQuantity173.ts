...
export class BTParameterSpecQuantity173 extends BTParameterSpec6 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecQuantity173.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecQuantity173";
    }
}
