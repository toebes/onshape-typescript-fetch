...
export class BTPLiteralUndefined260 extends BTPLiteral253 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPLiteralUndefined260.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPLiteralUndefined260";
    }
}
