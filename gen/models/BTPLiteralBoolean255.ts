...
export class BTPLiteralBoolean255 extends BTPLiteral253 {
    'btType'?: string;
    'value'?: boolean;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPLiteralBoolean255.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPLiteralBoolean255";
    }
}
