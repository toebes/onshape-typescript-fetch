...
export class BTPPredicateDeclaration265 extends BTPFunctionOrPredicateDeclaration247 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPPredicateDeclaration265.attributeTypeMap);
    }
