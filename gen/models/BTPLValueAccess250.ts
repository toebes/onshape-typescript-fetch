...
export class BTPLValueAccess250 extends BTPLValue249 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPLValueAccess250.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPLValueAccess250";
    }
}
