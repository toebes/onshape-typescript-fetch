...
export class BTAssemblyModificationParams {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "baseName": "deleteInstances",
            "type": "Array<string>",
            "format": ""
        },
        {
            "name": "editDescription",
            "baseName": "editDescription",
            "type": "string",
            "format": ""
        },
        {
            "name": "suppressInstances",
            "baseName": "suppressInstances",
            "type": "Array<string>",
            "format": ""
        },
        {
            "name": "transformDefinitions",
            "baseName": "transformDefinitions",
            "type": "Array<BTAssemblyTransformDefinitionParams>",
            "format": ""
        },
        {
            "name": "unsuppressInstances",
            "baseName": "unsuppressInstances",
            "type": "Array<string>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTAssemblyModificationParams.attributeTypeMap;
    }
