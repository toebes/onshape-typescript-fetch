...
export class BTMIndividualCoEdgeQuery1332 extends BTMIndividualQuery138 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMIndividualCoEdgeQuery1332.attributeTypeMap);
    }
