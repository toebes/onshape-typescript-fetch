...
export class BTParameterSpecNullableQuantity715 extends BTParameterSpec6 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecNullableQuantity715.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecNullableQuantity715";
    }
}
