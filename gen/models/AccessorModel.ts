...
export class AccessorModel {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "accessorData",
            "baseName": "accessorData",
            "type": "AccessorData",
            "format": ""
        },
        {
            "name": "bufferViewModel",
            "baseName": "bufferViewModel",
        ...
        {
            "name": "componentSizeInBytes",
            "baseName": "componentSizeInBytes",
            "type": "number",
            "format": "int32"
        },
        {
    ...
    static getAttributeTypeMap() {
        return AccessorModel.attributeTypeMap;
    }
