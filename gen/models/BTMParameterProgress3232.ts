...
export class BTMParameterProgress3232 extends BTMReadOnlyParameter3800 {
    'btType'?: string;
    'percentDone'?: number;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMParameterProgress3232.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMParameterProgress3232";
    }
}
