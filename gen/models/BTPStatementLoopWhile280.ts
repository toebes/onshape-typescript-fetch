...
export class BTPStatementLoopWhile280 extends BTPStatementLoop277 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementLoopWhile280.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementLoopWhile280";
    }
}
