...
export class BTFSTable953 extends BTTable1825 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "hiddenColumnIdsToNames",
            "baseName": "hiddenColumnIdsToNames",
            "type": "{ [key: string]: string; }",
            "format": ""
        },
        {
            "name": "individualTableProperties",
            "baseName": "individualTableProperties",
            "type": "BTIndividualTableProperties3760",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTFSTable953.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTFSTable953";
    }
}
