...
export class BTModelFormatFullInfo {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "validDestinationFormat",
            "baseName": "validDestinationFormat",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "validSourceFormat",
            "baseName": "validSourceFormat",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTModelFormatFullInfo.attributeTypeMap;
    }
