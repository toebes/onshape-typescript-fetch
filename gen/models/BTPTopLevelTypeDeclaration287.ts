...
export class BTPTopLevelTypeDeclaration287 extends BTPTopLevelNode286 {
    'btType'?: string;
    'name'?: BTPIdentifier8;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPTopLevelTypeDeclaration287.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPTopLevelTypeDeclaration287";
        this.btType = "BTPTopLevelTypeDeclaration287";
    }
}
