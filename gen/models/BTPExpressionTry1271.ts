...
export class BTPExpressionTry1271 extends BTPExpression9 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceAfterSilent",
            "baseName": "spaceAfterSilent",
            "type": "BTPSpace10",
            "format": ""
        },
        {
            "name": "spaceAfterTry",
            "baseName": "spaceAfterTry",
            "type": "BTPSpace10",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionTry1271.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionTry1271";
    }
}
