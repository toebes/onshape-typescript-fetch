...
export class BTUserAdminSummaryInfo extends BTUserSummaryInfo {
    'activePlanId'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTUserAdminSummaryInfo.attributeTypeMap);
    }
