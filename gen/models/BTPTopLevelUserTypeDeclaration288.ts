...
export class BTPTopLevelUserTypeDeclaration288 extends BTPTopLevelTypeDeclaration287 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPTopLevelUserTypeDeclaration288.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPTopLevelUserTypeDeclaration288";
    }
}
