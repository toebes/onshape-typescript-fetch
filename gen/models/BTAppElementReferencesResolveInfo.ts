...
export class BTAppElementReferencesResolveInfo {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "baseName": "resolvedReferences",
            "type": "Array<BTAppElementReferenceResolveInfo>",
            "format": ""
        },
        {
            "name": "unresolvedReferenceIds",
            "baseName": "unresolvedReferenceIds",
            "type": "Array<string>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTAppElementReferencesResolveInfo.attributeTypeMap;
    }
