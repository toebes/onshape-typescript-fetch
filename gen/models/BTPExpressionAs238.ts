...
export class BTPExpressionAs238 extends BTPExpression9 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionAs238.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionAs238";
    }
}
