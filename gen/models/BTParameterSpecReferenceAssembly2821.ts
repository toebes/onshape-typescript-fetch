...
export class BTParameterSpecReferenceAssembly2821 extends BTParameterSpecReference2789 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecReferenceAssembly2821.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecReferenceAssembly2821";
    }
}
