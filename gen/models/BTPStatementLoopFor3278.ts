...
export class BTPStatementLoopFor3278 extends BTPStatementLoop277 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceAfterInitialization",
            "baseName": "spaceAfterInitialization",
            "type": "BTPSpace10",
            "format": ""
        },
        {
            "name": "spaceBeforeCondition",
            "baseName": "spaceBeforeCondition",
            "type": "BTPSpace10",
            "format": ""
        },
        {
            "name": "spaceBeforeIncrement",
            "baseName": "spaceBeforeIncrement",
            "type": "BTPSpace10",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementLoopFor3278.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementLoopFor3278";
    }
}
