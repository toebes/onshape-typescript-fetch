...
export class BTPTopLevelEnumDeclaration284 extends BTPTopLevelTypeDeclaration287 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPTopLevelEnumDeclaration284.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPTopLevelEnumDeclaration284";
    }
}
