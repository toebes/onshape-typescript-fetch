...
export class BTPIdentifier8 extends BTPPropertyAccessor23 {
    'btType'?: string;
    'identifier'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "invalidIdentifierForTest",
            "baseName": "invalidIdentifierForTest",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPIdentifier8.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPIdentifier8";
    }
}
