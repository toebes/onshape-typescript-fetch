...
export class BTMRecordMetrics1169 extends BTMNode19 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "doBodyValidation",
            "baseName": "doBodyValidation",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "previousFeatureId",
            "baseName": "previousFeatureId",
            "type": "string",
            "format": ""
        },
        {
        ...
        {
            "name": "useLatestBehavior",
            "baseName": "useLatestBehavior",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMRecordMetrics1169.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMRecordMetrics1169";
    }
}
