...
export class BTPStatementBreak272 extends BTPStatement269 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceAfterBreak",
            "baseName": "spaceAfterBreak",
            "type": "BTPSpace10",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementBreak272.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementBreak272";
    }
}
