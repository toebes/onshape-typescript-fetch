...
export class BTOriginEntity935 extends BTFeatureEntity34 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTOriginEntity935.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTOriginEntity935";
    }
}
