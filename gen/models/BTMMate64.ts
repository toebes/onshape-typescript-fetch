...
export class BTMMate64 extends BTMAssemblyFeature887 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "mateConnectorQueryList",
            "baseName": "mateConnectorQueryList",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMMate64.attributeTypeMap);
    }
