...
export class BTSketchObjectFilter184 extends BTQueryFilter183 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTSketchObjectFilter184.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTSketchObjectFilter184";
    }
}
