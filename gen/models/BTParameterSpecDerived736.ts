...
export class BTParameterSpecDerived736 extends BTParameterSpec6 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecDerived736.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecDerived736";
    }
}
