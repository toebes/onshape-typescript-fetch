...
export class BTInstanceControlNode750 extends BTMNode19 {
    'btType'?: string;
    'suppressed'?: boolean;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTInstanceControlNode750.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTInstanceControlNode750";
    }
}
