...
export class BTExplosion2754 extends BTMAssemblyFeature887 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "explodeSteps",
            "baseName": "explodeSteps",
            "type": "Array<BTExplosionStepFeature3008>",
            "format": ""
        },
        {
            "name": "startingPositionId",
            "baseName": "startingPositionId",
            "type": "BTMicroversionIdAndConfiguration2338",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTExplosion2754.attributeTypeMap);
    }
