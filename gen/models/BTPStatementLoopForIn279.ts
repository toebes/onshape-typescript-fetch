...
export class BTPStatementLoopForIn279 extends BTPStatementLoop277 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "isVarDeclaredHere",
            "baseName": "isVarDeclaredHere",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementLoopForIn279.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementLoopForIn279";
    }
}
