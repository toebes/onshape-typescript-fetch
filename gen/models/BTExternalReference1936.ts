...
export class BTExternalReference1936 extends BTElementReference725 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTExternalReference1936.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTExternalReference1936";
    }
}
