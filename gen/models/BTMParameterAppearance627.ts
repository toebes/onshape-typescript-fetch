...
export class BTMParameterAppearance627 extends BTMParameter1 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMParameterAppearance627.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMParameterAppearance627";
    }
}
