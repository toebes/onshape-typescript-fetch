...
export class BTConfiguredFeatureColumnInfo1014 extends BTConfiguredValuesColumnInfo1025 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTConfiguredFeatureColumnInfo1014.attributeTypeMap);
    }
