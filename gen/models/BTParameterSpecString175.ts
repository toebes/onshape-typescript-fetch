...
export class BTParameterSpecString175 extends BTParameterSpec6 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "disallowsEmptyStrings",
            "baseName": "disallowsEmptyStrings",
            "type": "string",
            "format": ""
        },
        {
            "name": "disallowsHtml",
            "baseName": "disallowsHtml",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecString175.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecString175";
    }
}
