...
export class BTMParameterForeignId146 extends BTMParameter1 {
    'btType'?: string;
    'foreignId'?: string;
    'foreignName'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "foreignName",
            "baseName": "foreignName",
            "type": "string",
            "format": ""
        },
        {
            "name": "locationInfo",
            "baseName": "locationInfo",
            "type": "BTForeignDataResponse1070",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMParameterForeignId146.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMParameterForeignId146";
    }
}
