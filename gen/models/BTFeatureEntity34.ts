...
export class BTFeatureEntity34 extends BTBaseEntityData33 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "domainSpecificMetadata",
            "baseName": "domainSpecificMetadata",
            "type": "Array<BTDomainSpecificMetadata961>",
            "format": ""
        },
        {
            "name": "firstGeometry",
            "baseName": "firstGeometry",
            "type": "BTEntityGeometry35",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTFeatureEntity34.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTFeatureEntity34";
        this.btType = "BTFeatureEntity34";
    }
}
