...
export class BTAssemblyPattern1974 extends BTParametricInstance2641 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "patternFeature",
            "baseName": "patternFeature",
            "type": "BTMAssemblyPatternFeature2241",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTAssemblyPattern1974.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTAssemblyPattern1974";
    }
}
