...
export class BTPLiteralString259 extends BTPLiteral253 {
    'btType'?: string;
    'text'?: string;
    'value'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPLiteralString259.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPLiteralString259";
    }
}
