...
export class BTParameterSpecEnum171 extends BTParameterSpec6 {
    'btType'?: string;
    'enumName'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecEnum171.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecEnum171";
    }
}
