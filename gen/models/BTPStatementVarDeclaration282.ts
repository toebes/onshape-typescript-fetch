...
export class BTPStatementVarDeclaration282 extends BTPStatement269 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementVarDeclaration282.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementVarDeclaration282";
    }
}
