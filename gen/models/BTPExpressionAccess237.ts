...
export class BTPExpressionAccess237 extends BTPExpression9 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceInAccessor",
            "baseName": "spaceInAccessor",
            "type": "BTPSpace10",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionAccess237.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionAccess237";
    }
}
