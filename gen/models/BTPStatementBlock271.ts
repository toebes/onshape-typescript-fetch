...
export class BTPStatementBlock271 extends BTPStatement269 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceAfterOpen",
            "baseName": "spaceAfterOpen",
            "type": "BTPSpace10",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementBlock271.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementBlock271";
    }
}
