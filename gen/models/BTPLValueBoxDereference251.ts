...
export class BTPLValueBoxDereference251 extends BTPLValue249 {
    'btType'?: string;
    'box'?: BTPExpression9;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceInside",
            "baseName": "spaceInside",
            "type": "BTPSpace10",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPLValueBoxDereference251.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPLValueBoxDereference251";
    }
}
