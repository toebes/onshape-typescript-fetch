...
export class BTPExpressionFunction1325 extends BTPExpression9 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceAfterFunction",
            "baseName": "spaceAfterFunction",
            "type": "BTPSpace10",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionFunction1325.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionFunction1325";
    }
}
