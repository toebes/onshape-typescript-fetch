...
export class BTPStatementLoop277 extends BTPStatement269 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceAfterLoopType",
            "baseName": "spaceAfterLoopType",
            "type": "BTPSpace10",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementLoop277.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementLoop277";
        this.btType = "BTPStatementLoop277";
    }
}
