...
export class BTPProcedureDeclarationBase266 extends BTPTopLevelNode286 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPProcedureDeclarationBase266.attributeTypeMap);
    }
