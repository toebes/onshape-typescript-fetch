...
export class BTUserOAuth2SummaryInfo extends BTUserSummaryInfo {
    'clientId'?: string;
    'companyPlan'?: boolean;
    'oauth2Scopes'?: number;
    'planGroup'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTUserOAuth2SummaryInfo.attributeTypeMap);
    }
