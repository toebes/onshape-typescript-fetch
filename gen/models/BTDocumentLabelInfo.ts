...
export class BTDocumentLabelInfo extends BTGlobalTreeNodeInfo {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTDocumentLabelInfo.attributeTypeMap);
    }

    public constructor() {
        super();
        this.jsonType = "BTDocumentLabelInfo";
    }
}
