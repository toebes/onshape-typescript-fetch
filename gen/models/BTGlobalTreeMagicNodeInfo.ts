...
export class BTGlobalTreeMagicNodeInfo extends BTGlobalTreeNodeInfo {
    'subType'?: number;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTGlobalTreeMagicNodeInfo.attributeTypeMap);
    }

    public constructor() {
        super();
        this.jsonType = "BTGlobalTreeMagicNodeInfo";
    }
}
