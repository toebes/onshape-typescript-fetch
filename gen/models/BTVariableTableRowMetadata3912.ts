...
export class BTVariableTableRowMetadata3912 extends BTTableBaseRowMetadata3181 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "crossHighlightData",
            "baseName": "crossHighlightData",
        ...
        },
        {
            ...
            "baseName": "isFullyEditable",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "isRecursiveImport",
            "baseName": "isRecursiveImport",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "lastWritingFeatureNodeId",
            "baseName": "lastWritingFeatureNodeId",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTVariableTableRowMetadata3912.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTVariableTableRowMetadata3912";
    }
}
