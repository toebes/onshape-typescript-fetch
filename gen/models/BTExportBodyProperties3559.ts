...
export class BTExportBodyProperties3559 extends BTExportModelProperties3216 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTExportBodyProperties3559.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTExportBodyProperties3559";
    }
}
