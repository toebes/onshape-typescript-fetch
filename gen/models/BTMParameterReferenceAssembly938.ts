...
export class BTMParameterReferenceAssembly938 extends BTMParameterReferenceWithConfiguration3028 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMParameterReferenceAssembly938.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMParameterReferenceAssembly938";
    }
}
