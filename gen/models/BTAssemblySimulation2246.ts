...
export class BTAssemblySimulation2246 extends BTMAssemblyFeature887 {
    'btType'?: string;
    'modal'?: boolean;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTAssemblySimulation2246.attributeTypeMap);
    }
