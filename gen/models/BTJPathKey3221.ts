...
*/
export class BTJPathKey3221 extends BTJPathElement2297 {
    'btType'?: string;
    'key'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTJPathKey3221.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTJPathKey3221";
    }
}
