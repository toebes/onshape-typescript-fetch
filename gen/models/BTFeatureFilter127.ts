...
export class BTFeatureFilter127 extends BTQueryFilter183 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTFeatureFilter127.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTFeatureFilter127";
    }
}
