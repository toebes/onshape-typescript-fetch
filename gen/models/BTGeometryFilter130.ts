...
export class BTGeometryFilter130 extends BTQueryFilter183 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "geometryType",
            "baseName": "geometryType",
            "type": "GBTGeometryType",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTGeometryFilter130.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTGeometryFilter130";
    }
}
