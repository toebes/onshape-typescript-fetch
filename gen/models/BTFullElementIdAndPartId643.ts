...
export class BTFullElementIdAndPartId643 extends BTFullElementIdWithDocument1729 {
    'btType'?: string;
    'partId'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTFullElementIdAndPartId643.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTFullElementIdAndPartId643";
    }
}
