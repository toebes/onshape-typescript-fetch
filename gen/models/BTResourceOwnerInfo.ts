...
export class BTResourceOwnerInfo extends BTGlobalTreeNodeInfo {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "isEnterpriseEdu",
            "baseName": "isEnterpriseEdu",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTResourceOwnerInfo.attributeTypeMap);
    }

    public constructor() {
        super();
        this.jsonType = "BTResourceOwnerInfo";
    }
}
