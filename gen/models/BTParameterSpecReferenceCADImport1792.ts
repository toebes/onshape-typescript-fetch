...
export class BTParameterSpecReferenceCADImport1792 extends BTParameterSpecReferenceBlob1367 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecReferenceCADImport1792.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecReferenceCADImport1792";
    }
}
