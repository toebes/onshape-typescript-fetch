...
export class BTMGenerativeDesignFeature3195 extends BTMAssemblyFeature887 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "additiveSupportsOccurrences",
            "baseName": "additiveSupportsOccurrences",
            "type": "Array<BTOccurrence74>",
            "format": ""
        },
        {
            "name": "draftOccurrences",
            "baseName": "draftOccurrences",
            "type": "Array<BTOccurrence74>",
            "format": ""
        },
        {
            "name": "extrusionOccurrences",
            "baseName": "extrusionOccurrences",
            "type": "Array<BTOccurrence74>",
            "format": ""
        },
        {
        ...
        {
            "name": "millingOccurrences",
            "baseName": "millingOccurrences",
            "type": "Array<BTOccurrence74>",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMGenerativeDesignFeature3195.attributeTypeMap);
    }
