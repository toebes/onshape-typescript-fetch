...
export class BTFlatSheetMetalFilter3018 extends BTQueryFilter183 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTFlatSheetMetalFilter3018.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTFlatSheetMetalFilter3018";
    }
}
