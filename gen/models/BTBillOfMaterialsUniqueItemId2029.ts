...
export class BTBillOfMaterialsUniqueItemId2029 {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "sourceElement",
            "baseName": "sourceElement",
            "type": "BTElementReference725",
            "format": ""
        },
        {
            "name": "versionMetadataWorkspaceId",
            "baseName": "versionMetadataWorkspaceId",
            "type": "string",
            "format": ""
        },
        {
            "name": "versionMetadataWorkspaceMicroversionId",
            "baseName": "versionMetadataWorkspaceMicroversionId",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTBillOfMaterialsUniqueItemId2029.attributeTypeMap;
    }
