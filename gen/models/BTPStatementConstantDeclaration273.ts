...
export class BTPStatementConstantDeclaration273 extends BTPStatement269 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementConstantDeclaration273.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementConstantDeclaration273";
    }
}
