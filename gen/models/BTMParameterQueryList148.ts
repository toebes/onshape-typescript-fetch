...
export class BTMParameterQueryList148 extends BTMParameter1 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMParameterQueryList148.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMParameterQueryList148";
    }
}
