...
export class BTTableCellPropertyParameter2983 extends BTTableCellParameter2399 {
    'btType'?: string;
    'isUnchanged'?: boolean;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "isUnchanged",
            "baseName": "isUnchanged",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "overrideStatusType",
            "baseName": "overrideStatusType",
            "type": "GBTMetadataOverrideStatusType",
            "format": ""
        },
        {
            "name": "propertySourceType",
            "baseName": "propertySourceType",
            "type": "GBTMetadataSourceType",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTTableCellPropertyParameter2983.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTTableCellPropertyParameter2983";
    }
}
