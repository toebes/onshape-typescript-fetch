...
export class BTConfiguredSuppressionColumnInfo2498 extends BTConfiguredValuesColumnInfo1025 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTConfiguredSuppressionColumnInfo2498.attributeTypeMap);
    }
