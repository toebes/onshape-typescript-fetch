...
export class BTTableAssemblyCrossHighlightData2675 extends BTTableBaseCrossHighlightData2609 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "assemblyCrossHighlightItems",
            "baseName": "assemblyCrossHighlightItems",
            "type": "Array<BTTableAssemblyCrossHighlightDataItem2659>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTTableAssemblyCrossHighlightData2675.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTTableAssemblyCrossHighlightData2675";
    }
}
