...
export class BTViewManipulationMouseKeyMappingInfo {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "axisRotate3DMapping",
            "baseName": "axisRotate3DMapping",
            "type": "Array<BTKeyMouseValuesInfo>",
            "format": ""
        },
        {
            "name": "pan2DMapping",
            "baseName": "pan2DMapping",
            "type": "Array<BTKeyMouseValuesInfo>",
            "format": ""
        },
        {
            "name": "pan3DMapping",
            "baseName": "pan3DMapping",
            "type": "Array<BTKeyMouseValuesInfo>",
            "format": ""
        },
        {
            "name": "rotate3DMapping",
            "baseName": "rotate3DMapping",
            "type": "Array<BTKeyMouseValuesInfo>",
            "format": ""
        },
        {
            "name": "zoom2DMapping",
            "baseName": "zoom2DMapping",
            "type": "Array<BTKeyMouseValuesInfo>",
            "format": ""
        },
        {
            "name": "zoom3DMapping",
            "baseName": "zoom3DMapping",
            "type": "Array<BTKeyMouseValuesInfo>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTViewManipulationMouseKeyMappingInfo.attributeTypeMap;
    }
