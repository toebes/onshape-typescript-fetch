...
export class BTBaseEntityData33 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "copyWithoutGeometry",
            "baseName": "copyWithoutGeometry",
    ...
    static getAttributeTypeMap() {
        return BTBaseEntityData33.attributeTypeMap;
    }

    public constructor() {
        this.btType = "BTBaseEntityData33";
    }
}
