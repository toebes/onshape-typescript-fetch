...
export class BTPExpressionBuiltinCall239 extends BTPExpression9 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionBuiltinCall239.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionBuiltinCall239";
    }
}
