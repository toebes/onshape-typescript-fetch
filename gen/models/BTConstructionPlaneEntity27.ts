...
export class BTConstructionPlaneEntity27 extends BTFeatureEntity34 {
    'btType'?: string;
    'isDefault'?: boolean;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTConstructionPlaneEntity27.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTConstructionPlaneEntity27";
    }
}
