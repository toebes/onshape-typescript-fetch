...
export class BTMateConnectorEntity28 extends BTFeatureEntity34 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMateConnectorEntity28.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMateConnectorEntity28";
    }
}
