...
export class BTParameterSpecReferenceWithConfiguration2950 extends BTParameterSpecReference2789 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "allowAssemblies",
            "baseName": "allowAssemblies",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecReferenceWithConfiguration2950.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecReferenceWithConfiguration2950";
    }
}
