...
export class BTPExpressionIs242 extends BTPExpression9 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionIs242.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionIs242";
    }
}
