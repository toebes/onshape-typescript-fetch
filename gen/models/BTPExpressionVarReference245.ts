...
export class BTPExpressionVarReference245 extends BTPExpression9 {
    'btType'?: string;
    'name'?: BTPName261;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionVarReference245.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionVarReference245";
    }
}
