...
export class BTSphereDescription1263 extends BTSurfaceDescription1564 {
    'btType'?: string;
    'radius'?: number;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTSphereDescription1263.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTSphereDescription1263";
    }
}
