...
export class BTMIndividualCreatedByQuery137 extends BTMIndividualQuery138 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "filterConstruction",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMIndividualCreatedByQuery137.attributeTypeMap);
    }
