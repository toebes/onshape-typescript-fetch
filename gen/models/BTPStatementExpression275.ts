...
export class BTPStatementExpression275 extends BTPStatement269 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementExpression275.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementExpression275";
    }
}
