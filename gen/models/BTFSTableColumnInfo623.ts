...
export class BTFSTableColumnInfo623 extends BTTableColumnInfo1222 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTFSTableColumnInfo623.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTFSTableColumnInfo623";
    }
}
