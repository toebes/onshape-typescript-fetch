...
export class BTExportTessellatedEdgesBody890 extends BTExportTessellatedBody3398 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTExportTessellatedEdgesBody890.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTExportTessellatedEdgesBody890";
    }
}
