...
export class BTPExpressionSwitch2632 extends BTPExpression9 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceAfterSwitch",
            "baseName": "spaceAfterSwitch",
            "type": "BTPSpace10",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionSwitch2632.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionSwitch2632";
    }
}
