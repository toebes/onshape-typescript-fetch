...
export class BTPLValueVarReference252 extends BTPLValue249 {
    'btType'?: string;
    'name'?: BTPIdentifier8;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPLValueVarReference252.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPLValueVarReference252";
    }
}
