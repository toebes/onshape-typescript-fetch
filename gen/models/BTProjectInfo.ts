...
export class BTProjectInfo extends BTGlobalTreeNodeInfo {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTProjectInfo.attributeTypeMap);
    }

    public constructor() {
        super();
        this.jsonType = "BTProjectInfo";
    }
}
