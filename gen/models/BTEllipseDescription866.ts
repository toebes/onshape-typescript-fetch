...
export class BTEllipseDescription866 extends BTCurveDescription1583 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTEllipseDescription866.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTEllipseDescription866";
    }
}
