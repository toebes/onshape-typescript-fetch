...
export class BTPExpressionNew243 extends BTPExpression9 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceAfterBox",
            "baseName": "spaceAfterBox",
            "type": "BTPSpace10",
            "format": ""
        },
        {
            "name": "spaceBetweenNewBox",
            "baseName": "spaceBetweenNewBox",
            "type": "BTPSpace10",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionNew243.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionNew243";
    }
}
