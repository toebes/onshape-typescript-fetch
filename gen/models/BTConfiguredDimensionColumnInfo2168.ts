...
export class BTConfiguredDimensionColumnInfo2168 extends BTConfiguredValuesColumnInfo1025 {
    'btType'?: string;
    'dimensionId'?: string;
    'parameterId'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTConfiguredDimensionColumnInfo2168.attributeTypeMap);
    }
