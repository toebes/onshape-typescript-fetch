...
export class BTMFeatureQueryWithOccurrence157 extends BTMIndividualQueryWithOccurrenceBase904 {
    'btType'?: string;
    'featureId'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "featureIdWithOccurrence",
            "baseName": "featureIdWithOccurrence",
            "type": "string",
            "format": ""
        },
        {
            "name": "partStudioMateConnectorQuery",
            "baseName": "partStudioMateConnectorQuery",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMFeatureQueryWithOccurrence157.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMFeatureQueryWithOccurrence157";
        this.btType = "BTMFeatureQueryWithOccurrence157";
    }
}
