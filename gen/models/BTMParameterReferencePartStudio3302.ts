...
export class BTMParameterReferencePartStudio3302 extends BTMParameterReferenceWithConfiguration3028 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "blockBuildFunctionAccess",
            "baseName": "blockBuildFunctionAccess",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMParameterReferencePartStudio3302.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMParameterReferencePartStudio3302";
    }
}
