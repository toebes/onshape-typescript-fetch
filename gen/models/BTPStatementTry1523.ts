...
export class BTPStatementTry1523 extends BTPStatement269 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementTry1523.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementTry1523";
    }
}
