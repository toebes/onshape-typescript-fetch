...
export class BTLoadDisplayData837 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "componentValues",
            "type": "BTVector3d389",
            "format": ""
        },
        {
            "name": "directionMateConnectorId",
            "baseName": "directionMateConnectorId",
            "type": "string",
            "format": ""
        },
        {
            "name": "faceLoadDeterministicIds",
            "baseName": "faceLoadDeterministicIds",
            "type": "Array<string>",
            "format": ""
        },
        {
        ...
        {
            "name": "isDerivedFeature",
            "baseName": "isDerivedFeature",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "isDirectionFlipped",
            "baseName": "isDirectionFlipped",
            "type": "boolean",
            "format": ""
        },
        {
        ...
        {
            "name": "ownerOccurrence",
            "baseName": "ownerOccurrence",
            "type": "BTOccurrence74",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return BTLoadDisplayData837.attributeTypeMap;
    }
