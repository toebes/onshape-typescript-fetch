...
export class BTBodyEntity26 extends BTFeatureEntity34 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "doesNotUseLevelsOfDetail",
            "baseName": "doesNotUseLevelsOfDetail",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTBodyEntity26.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTBodyEntity26";
    }
}
