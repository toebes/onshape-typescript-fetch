...
export class BTPartProperties293 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "configuredParts",
            "baseName": "configuredParts",
            "type": "BTConfiguredPartProperties2645",
            "format": ""
        },
        {
            "name": "identityIdToQueryIndex",
            "baseName": "identityIdToQueryIndex",
        ...
        {
            "name": "roughBytesEstimate",
            "baseName": "roughBytesEstimate",
            "type": "number",
            "format": "int64"
        },
        {
            "name": "tessellationProperties",
            "baseName": "tessellationProperties",
            "type": "BTTessellationProperties927",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTPartProperties293.attributeTypeMap;
    }
