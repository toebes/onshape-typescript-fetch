...
export class BTConeDescription860 extends BTSurfaceDescription1564 {
    'btType'?: string;
    'axis'?: BTVector3d389;
    'halfAngle'?: number;
    'radius'?: number;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTConeDescription860.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTConeDescription860";
    }
}
