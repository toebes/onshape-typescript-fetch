...
export class BTMParametricPartStudioFeature3883 extends BTMAssemblyFeature887 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMParametricPartStudioFeature3883.attributeTypeMap);
    }
