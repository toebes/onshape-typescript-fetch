...
export class BTMAssemblyReplicateFeature1351 extends BTMAssemblyFeature887 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMAssemblyReplicateFeature1351.attributeTypeMap);
    }
