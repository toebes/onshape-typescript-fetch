...
export class BTMPartStudioMateConnectorQuery1324 extends BTMFeatureQueryWithOccurrence157 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMPartStudioMateConnectorQuery1324.attributeTypeMap);
    }
