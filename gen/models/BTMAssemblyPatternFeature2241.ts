...
export class BTMAssemblyPatternFeature2241 extends BTMAssemblyFeature887 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMAssemblyPatternFeature2241.attributeTypeMap);
    }
