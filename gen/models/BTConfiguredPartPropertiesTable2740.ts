...
export class BTConfiguredPartPropertiesTable2740 extends BTTable1825 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "partDeterministicId",
            "baseName": "partDeterministicId",
            "type": "string",
            "format": ""
        },
        {
            "name": "partDeterministicIds",
            "baseName": "partDeterministicIds",
            "type": "Array<string>",
            "format": ""
        },
        {
            "name": "propertyNodeId",
            "baseName": "propertyNodeId",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTConfiguredPartPropertiesTable2740.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTConfiguredPartPropertiesTable2740";
    }
}
