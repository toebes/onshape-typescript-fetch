...
export class BTPStatementReturn281 extends BTPStatement269 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceAfterReturn",
            "baseName": "spaceAfterReturn",
            "type": "BTPSpace10",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementReturn281.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementReturn281";
    }
}
