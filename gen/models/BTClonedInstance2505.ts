...
export class BTClonedInstance2505 extends BTParametricOutputInstance2288 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "seedOccurrence",
            "baseName": "seedOccurrence",
            "type": "BTOccurrence74",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTClonedInstance2505.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTClonedInstance2505";
    }
}
