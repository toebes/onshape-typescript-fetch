...
export class BTMicroversionIdAndConfiguration2338 {
    'btType'?: string;
    'cacheKey'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "configurationParameterIdToValue",
            "baseName": "configurationParameterIdToValue",
    ...
    static getAttributeTypeMap() {
        return BTMicroversionIdAndConfiguration2338.attributeTypeMap;
    }
