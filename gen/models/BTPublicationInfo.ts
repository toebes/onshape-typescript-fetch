...
export class BTPublicationInfo extends BTGlobalTreeNodeInfo {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPublicationInfo.attributeTypeMap);
    }

    public constructor() {
        super();
        this.jsonType = "BTPublicationInfo";
    }
}
