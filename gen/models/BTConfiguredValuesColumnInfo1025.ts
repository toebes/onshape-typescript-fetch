...
export class BTConfiguredValuesColumnInfo1025 extends BTTableColumnInfo1222 {
    'btType'?: string;
    'parentId'?: string;
    'parentName'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTConfiguredValuesColumnInfo1025.attributeTypeMap);
    }
