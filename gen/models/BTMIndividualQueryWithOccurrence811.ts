...
export class BTMIndividualQueryWithOccurrence811 extends BTMIndividualQueryWithOccurrenceBase904 {
    'btType'?: string;
    'entityQuery'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "entityQuery",
            "baseName": "entityQuery",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMIndividualQueryWithOccurrence811.attributeTypeMap);
    }
