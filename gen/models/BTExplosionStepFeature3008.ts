...
export class BTExplosionStepFeature3008 extends BTMAssemblyFeature887 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTExplosionStepFeature3008.attributeTypeMap);
    }
