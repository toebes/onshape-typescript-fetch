...
export class BTMConfigurationParameterEnum105 extends BTMConfigurationParameter819 {
    'btType'?: string;
    'defaultValue'?: string;
    'enumName'?: string;
    'namespace'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMConfigurationParameterEnum105.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMConfigurationParameterEnum105";
    }
}
