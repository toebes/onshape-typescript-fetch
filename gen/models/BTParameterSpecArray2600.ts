...
export class BTParameterSpecArray2600 extends BTParameterSpec6 {
    'btType'?: string;
    'drivenQuery'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "drivenQuery",
            "baseName": "drivenQuery",
            "type": "string",
            "format": ""
        },
        {
            "name": "itemLabelTemplate",
            "baseName": "itemLabelTemplate",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecArray2600.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecArray2600";
    }
}
