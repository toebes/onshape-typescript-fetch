...
export class BTGeometryMateDisplayData1050 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "firstDeterministicId",
            "baseName": "firstDeterministicId",
            "type": "string",
            "format": ""
        },
        {
            "name": "firstOccurrence",
            "baseName": "firstOccurrence",
            "type": "BTOccurrence74",
            "format": ""
        },
        {
        ...
        {
            "name": "secondDeterministicId",
            "baseName": "secondDeterministicId",
            "type": "string",
            "format": ""
        },
        {
            "name": "secondOccurrence",
            "baseName": "secondOccurrence",
            "type": "BTOccurrence74",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return BTGeometryMateDisplayData1050.attributeTypeMap;
    }
