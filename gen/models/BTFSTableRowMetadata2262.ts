...
export class BTFSTableRowMetadata2262 extends BTTableBaseRowMetadata3181 {
    'btType'?: string;
    'callout'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTFSTableRowMetadata2262.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTFSTableRowMetadata2262";
    }
}
