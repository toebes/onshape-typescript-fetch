...
export class BTPTopLevelConstantDeclaration283 extends BTPTopLevelNode286 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPTopLevelConstantDeclaration283.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPTopLevelConstantDeclaration283";
    }
}
