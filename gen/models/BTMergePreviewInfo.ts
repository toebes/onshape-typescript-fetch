...
export class BTMergePreviewInfo {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "branchPointMicroversionId",
            "baseName": "branchPointMicroversionId",
            "type": "string",
            "format": ""
        },
        {
            "name": "branchPointVersionId",
            "baseName": "branchPointVersionId",
            "type": "string",
            "format": ""
        },
        {
            "name": "branchPointWorkspaceId",
            "baseName": "branchPointWorkspaceId",
            "type": "string",
            "format": ""
        },
        {
        ...
        {
            "name": "isBranchPointAtStart",
            "baseName": "isBranchPointAtStart",
            "type": "boolean",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return BTMergePreviewInfo.attributeTypeMap;
    }
