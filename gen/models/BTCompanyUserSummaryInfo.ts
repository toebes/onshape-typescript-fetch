...
export class BTCompanyUserSummaryInfo extends BTUserSummaryInfo {
    'admin'?: boolean;
    'cls'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTCompanyUserSummaryInfo.attributeTypeMap);
    }

    public constructor() {
        super();
        this.jsonType = "BTCompanyUserSummaryInfo";
    }
}
