...
export class BTPlanarImageMapping4398 extends BTImageMapping3821 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "planeSystem",
            "baseName": "planeSystem",
            "type": "BTCoordinateSystem387",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPlanarImageMapping4398.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPlanarImageMapping4398";
    }
}
