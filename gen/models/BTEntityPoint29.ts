...
export class BTEntityPoint29 extends BTTessellatedGeometry2576 {
    'btType'?: string;
    'point'?: Array<number>;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTEntityPoint29.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTEntityPoint29";
    }
}
