...
export class BTMConfigurationData1560 extends BTMNode19 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "currentFSValues",
            "baseName": "currentFSValues",
            "type": "{ [key: string]: BTFSValue1888; }",
            "format": ""
        },
        {
            "name": "defaultConfigurationValues",
            "baseName": "defaultConfigurationValues",
            "type": "{ [key: string]: BTFSValue1888; }",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMConfigurationData1560.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMConfigurationData1560";
    }
}
