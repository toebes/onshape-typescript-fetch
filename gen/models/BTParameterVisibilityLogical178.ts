...
export class BTParameterVisibilityLogical178 extends BTParameterVisibilityCondition177 {
    'btType': string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterVisibilityLogical178.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterVisibilityLogical178";
    }
}
