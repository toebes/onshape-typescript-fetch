...
export class BTMParameterDerived864 extends BTMParameter1 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMParameterDerived864.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMParameterDerived864";
    }
}
