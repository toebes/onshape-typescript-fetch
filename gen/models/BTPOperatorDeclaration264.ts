...
export class BTPOperatorDeclaration264 extends BTPProcedureDeclarationBase266 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPOperatorDeclaration264.attributeTypeMap);
    }
