...
export class BTMicroversionIdAndConfigurationInterval2364 {
    'btType'?: string;
    '_from'?: BTMicroversionIdAndConfiguration2338;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "microversionIdInterval",
            "baseName": "microversionIdInterval",
    ...
    static getAttributeTypeMap() {
        return BTMicroversionIdAndConfigurationInterval2364.attributeTypeMap;
    }
