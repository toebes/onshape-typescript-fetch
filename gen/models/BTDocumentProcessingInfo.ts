...
export class BTDocumentProcessingInfo extends BTDocumentInfo {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "translationEventKey",
            "baseName": "translationEventKey",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTDocumentProcessingInfo.attributeTypeMap);
    }
