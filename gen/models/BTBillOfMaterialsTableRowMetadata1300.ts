...
export class BTBillOfMaterialsTableRowMetadata1300 extends BTTableBaseRowMetadata3181 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "crossHighlightDataIfAny",
            "baseName": "crossHighlightDataIfAny",
            "type": "BTTableAssemblyCrossHighlightData2675",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTBillOfMaterialsTableRowMetadata1300.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTBillOfMaterialsTableRowMetadata1300";
    }
}
