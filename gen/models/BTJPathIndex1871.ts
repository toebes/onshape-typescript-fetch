...
*/
export class BTJPathIndex1871 extends BTJPathElement2297 {
    'btType'?: string;
    'index'?: number;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTJPathIndex1871.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTJPathIndex1871";
    }
}
