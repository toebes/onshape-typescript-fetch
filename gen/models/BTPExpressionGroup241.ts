...
export class BTPExpressionGroup241 extends BTPExpression9 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPExpressionGroup241.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPExpressionGroup241";
    }
}
