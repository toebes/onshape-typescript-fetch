...
export class BTMAssemblyFeatureFolder2543 extends BTMAssemblyFeature887 {
    'btType'?: string;
    'folderEnd'?: boolean;
    'folderStart'?: boolean;
    'startNodeId'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "folderStart",
            "baseName": "folderStart",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "startNodeId",
            "baseName": "startNodeId",
            "type": "string",
            "format": ""
        },
        {
            "name": "startNodeIdRaw",
            "baseName": "startNodeIdRaw",
            "type": "BTObjectId",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMAssemblyFeatureFolder2543.attributeTypeMap);
    }
