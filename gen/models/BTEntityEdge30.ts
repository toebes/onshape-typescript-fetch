...
export class BTEntityEdge30 extends BTTessellatedGeometry2576 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "compressedPoints",
            "baseName": "compressedPoints",
            "type": "BTImmutableByteArray",
            "format": ""
        },
        {
            "name": "edgeSmoothnessStatus",
            "baseName": "edgeSmoothnessStatus",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTEntityEdge30.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTEntityEdge30";
    }
}
