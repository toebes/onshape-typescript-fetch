...
export class BTParameterSpecLookupTablePath761 extends BTParameterSpec6 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "lookupTable",
            "baseName": "lookupTable",
            "type": "BTParameterLookupTableListEntry1916",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecLookupTablePath761.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecLookupTablePath761";
    }
}
