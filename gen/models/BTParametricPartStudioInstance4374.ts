...
export class BTParametricPartStudioInstance4374 extends BTParametricInstance2641 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "parametricPartStudioFeature",
            "baseName": "parametricPartStudioFeature",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParametricPartStudioInstance4374.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParametricPartStudioInstance4374";
    }
}
