...
export class BTPTopLevelImport285 extends BTPTopLevelNode286 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "combinedNamespacePathAndVersion",
            "baseName": "combinedNamespacePathAndVersion",
            "type": "string",
            "format": ""
        },
        {
        ...
        },
        {
            ...
            "baseName": "namespaceString",
            "type": "string",
            "format": ""
        },
        {
            "name": "spaceBeforeImport",
            "baseName": "spaceBeforeImport",
            "type": "BTPSpace10",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPTopLevelImport285.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPTopLevelImport285";
    }
}
