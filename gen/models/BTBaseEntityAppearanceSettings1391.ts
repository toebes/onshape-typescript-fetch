...
export class BTBaseEntityAppearanceSettings1391 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "colorIdToBaseEntityAppearanceEntry",
            "baseName": "colorIdToBaseEntityAppearanceEntry",
    ...
    static getAttributeTypeMap() {
        return BTBaseEntityAppearanceSettings1391.attributeTypeMap;
    }
