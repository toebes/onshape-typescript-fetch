...
export class BTParameterSpecFeatureList703 extends BTParameterSpec6 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecFeatureList703.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecFeatureList703";
    }
}
