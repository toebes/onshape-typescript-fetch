...
export class BTParameterExpressionErrorInfo2037 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "errorMessageIdentifier",
            "baseName": "errorMessageIdentifier",
            "type": "GBTErrorStringEnum",
            "format": ""
        },
        {
            "name": "messageArguments",
            "baseName": "messageArguments",
            "type": "Array<BTValueAndUse4696>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTParameterExpressionErrorInfo2037.attributeTypeMap;
    }
