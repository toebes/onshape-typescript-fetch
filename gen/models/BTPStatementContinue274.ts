...
export class BTPStatementContinue274 extends BTPStatement269 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "spaceAfterContinue",
            "baseName": "spaceAfterContinue",
            "type": "BTPSpace10",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementContinue274.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementContinue274";
    }
}
