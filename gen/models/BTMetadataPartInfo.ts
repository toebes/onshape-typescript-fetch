...
export class BTMetadataPartInfo extends BTMetadataObjectInfo {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMetadataPartInfo.attributeTypeMap);
    }

    public constructor() {
        super();
        this.jsonType = "BTMetadataPartInfo";
    }
}
