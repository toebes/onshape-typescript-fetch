...
export class BTParameterSpecReference2789 extends BTParameterSpec6 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "defaultPurpose",
            "baseName": "defaultPurpose",
            "type": "BTElementLibraryPurpose3353",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecReference2789.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecReference2789";
        this.btType = "BTParameterSpecReference2789";
    }
}
