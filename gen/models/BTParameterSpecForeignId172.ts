...
export class BTParameterSpecForeignId172 extends BTParameterSpec6 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecForeignId172.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecForeignId172";
    }
}
