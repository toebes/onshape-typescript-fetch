...
export class BTAssemblyInsertTransformedInstancesResponse {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "insertInstanceResponses",
            "baseName": "insertInstanceResponses",
            "type": "Array<BTAssemblyInstanceOccurrenceInfo>",
            "format": ""
        },
        {
            "name": "insertResponses",
            "baseName": "insertResponses",
            "type": "Array<BTAssemblyOccurrenceInfo>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return BTAssemblyInsertTransformedInstancesResponse.attributeTypeMap;
    }
