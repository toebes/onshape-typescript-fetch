...
export class BTMIndividualSketchRegionQuery140 extends BTMIndividualQuery138 {
    'btType'?: string;
    'featureId'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "filterInnerLoops",
            "baseName": "filterInnerLoops",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMIndividualSketchRegionQuery140.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMIndividualQuery138";
    }
}
