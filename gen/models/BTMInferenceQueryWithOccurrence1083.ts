...
export class BTMInferenceQueryWithOccurrence1083 extends BTMIndividualQueryWithOccurrence811 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "secondEntityQuery",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTMInferenceQueryWithOccurrence1083.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTMIndividualQueryWithOccurrence811";
    }
}
