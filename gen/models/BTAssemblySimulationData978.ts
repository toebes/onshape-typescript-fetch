...
export class BTAssemblySimulationData978 extends BTMNode19 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "contactBehavior",
            "baseName": "contactBehavior",
        ...
        {
            "name": "structuralLoads",
            "baseName": "structuralLoads",
            "type": "Array<BTMLoad3538>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTAssemblySimulationData978.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTAssemblySimulationData978";
    }
}
