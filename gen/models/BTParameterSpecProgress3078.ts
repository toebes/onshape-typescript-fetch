...
export class BTParameterSpecProgress3078 extends BTReadOnlyParameterSpec1889 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTParameterSpecProgress3078.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTParameterSpecProgress3078";
    }
}
