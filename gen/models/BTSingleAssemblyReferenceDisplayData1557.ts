...
export class BTSingleAssemblyReferenceDisplayData1557 extends BTSingleReferenceDisplayData1943 {
    'btType'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "assemblyDisplayData",
            "baseName": "assemblyDisplayData",
            "type": "BTRootAssemblyDisplayData96",
            "format": ""
        },
        {
            "name": "occurrencesToExclude",
            "baseName": "occurrencesToExclude",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTSingleAssemblyReferenceDisplayData1557.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTSingleAssemblyReferenceDisplayData1557";
    }
}
