...
export class BTPStatementThrow1080 extends BTPStatement269 {
    'btType'?: string;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BTPStatementThrow1080.attributeTypeMap);
    }

    public constructor() {
        super();
        this.btType = "BTPStatementThrow1080";
    }
}
