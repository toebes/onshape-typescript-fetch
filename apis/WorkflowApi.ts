...
export interface EnumerateObjectWorkflowsRequest {
    cid: string;
    objectTypes?: Array<EnumerateObjectWorkflowsObjectTypesEnum>;
    states?: Set<string>;
    limit?: number;
    modifiedAfter?: Date;
}
 ...
 * @export
 */
export const EnumerateObjectWorkflowsObjectTypesEnum = {
    Release: 'RELEASE',
    Task: 'TASK',
    Assignment: 'ASSIGNMENT',
    Obsoletion: 'OBSOLETION'
} as const;
export type EnumerateObjectWorkflowsObjectTypesEnum = typeof EnumerateObjectWorkflowsObjectTypesEnum[keyof typeof EnumerateObjectWorkflowsObjectTypesEnum];
