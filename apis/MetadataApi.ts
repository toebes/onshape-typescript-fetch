...
export interface GetVEOPStandardContentMetadataRequest {
    ...
    vid: string;
    eid: string;
    cu: GetVEOPStandardContentMetadataCuEnum;
    cuid: string;
    pid: string;
...
export interface UpdateVEOPStandardContentPartMetadataRequest {
    ...
    vid: string;
    eid: string;
    cu: UpdateVEOPStandardContentPartMetadataCuEnum;
    cuid: string;
    pid: string;
    body: string;
    linkDocumentId?: string;
...
export class MetadataApi extends runtime.BaseAPI {
    ...
    async getVEOPStandardContentMetadataRaw(requestParameters: GetVEOPStandardContentMetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BTMetadataObjectInfo>> {
        ...
        if (requestParameters.cu === null || requestParameters.cu === undefined) {
            throw new runtime.RequiredError('cu','Required parameter requestParameters.cu was null or undefined when calling getVEOPStandardContentMetadata.');
        }

        if (requestParameters.cuid === null || requestParameters.cuid === undefined) {
            throw new runtime.RequiredError('cuid','Required parameter requestParameters.cuid was null or undefined when calling getVEOPStandardContentMetadata.');
        }
        ...
        const response = await this.request({
            path: `/metadata/standardcontent/d/{did}/v/{vid}/e/{eid}/{cu}/{cuid}/p/{pid}`.replace(`{${"did"}}`, encodeURIComponent(String(requestParameters.did))).replace(`{${"vid"}}`, encodeURIComponent(String(requestParameters.vid))).replace(`{${"eid"}}`, encodeURIComponent(String(requestParameters.eid))).replace(`{${"cu"}}`, encodeURIComponent(String(requestParameters.cu))).replace(`{${"cuid"}}`, encodeURIComponent(String(requestParameters.cuid))).replace(`{${"pid"}}`, encodeURIComponent(String(requestParameters.pid))),
            method: 'GET',
    ...
    async updateVEOPStandardContentPartMetadataRaw(requestParameters: UpdateVEOPStandardContentPartMetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        ...
        if (requestParameters.vid === null || requestParameters.vid === undefined) {
            throw new runtime.RequiredError('vid','Required parameter requestParameters.vid was null or undefined when calling updateVEOPStandardContentPartMetadata.');
        }

        if (requestParameters.eid === null || requestParameters.eid === undefined) {
            throw new runtime.RequiredError('eid','Required parameter requestParameters.eid was null or undefined when calling updateVEOPStandardContentPartMetadata.');
        }

        if (requestParameters.cu === null || requestParameters.cu === undefined) {
            throw new runtime.RequiredError('cu','Required parameter requestParameters.cu was null or undefined when calling updateVEOPStandardContentPartMetadata.');
        }

        if (requestParameters.cuid === null || requestParameters.cuid === undefined) {
            throw new runtime.RequiredError('cuid','Required parameter requestParameters.cuid was null or undefined when calling updateVEOPStandardContentPartMetadata.');
        }

        if (requestParameters.pid === null || requestParameters.pid === undefined) {
            throw new runtime.RequiredError('pid','Required parameter requestParameters.pid was null or undefined when calling updateVEOPStandardContentPartMetadata.');
        }
 ...
 * @export
 */
export const GetVEOPStandardContentMetadataCuEnum = {
    C: 'c',
    U: 'u'
} as const;
export type GetVEOPStandardContentMetadataCuEnum = typeof GetVEOPStandardContentMetadataCuEnum[keyof typeof GetVEOPStandardContentMetadataCuEnum];
/**
 * @export
 */
 ...
 * @export
 */
export const UpdateVEOPStandardContentPartMetadataCuEnum = {
    C: 'c',
    U: 'u'
} as const;
export type UpdateVEOPStandardContentPartMetadataCuEnum = typeof UpdateVEOPStandardContentPartMetadataCuEnum[keyof typeof UpdateVEOPStandardContentPartMetadataCuEnum];
/**
 * @export
 */
