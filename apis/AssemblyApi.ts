...
export class AssemblyApi extends runtime.BaseAPI {
     ...
     */
    async createInstanceRaw(requestParameters: CreateInstanceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.did === null || requestParameters.did === undefined) {
     ...
     * Insert an instance of a part, sketch, assembly, or Part Studio into an assembly.
     */
    async createInstance(requestParameters: CreateInstanceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
